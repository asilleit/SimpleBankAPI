...
import { WebExporterEventEventArgsDescriptionMetadata } from "./WebExporterEventEventArgsDescriptionMetadata";
 ...
 * @hidden
 */
export let WebGridToolbarExporterDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebGridToolbarExporterDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.j(WebGridToolbarExporterDescriptionMetadata.a)) {
                return;
            }
            a.y(WebGridToolbarExporterDescriptionMetadata.a);
            WebExporterEventEventArgsDescriptionMetadata.d(a);
        ...
        static d(a) {
            ...
            a.aa("WebGridToolbarExporter", () => new WebGridToolbarExporterDescription());
            a.z("WebGridToolbarExporter", WebGridToolbarExporterDescriptionMetadata.a);
        }
    }
    WebGridToolbarExporterDescriptionMetadata.$t = /*@__PURE__*/ markType(WebGridToolbarExporterDescriptionMetadata, 'WebGridToolbarExporterDescriptionMetadata');
