 ...
 * @hidden
 */
export let WebPaginatorDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebPaginatorDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.j(WebPaginatorDescriptionMetadata.a)) {
                return;
            }
            a.y(WebPaginatorDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.aa("WebPaginator", () => new WebPaginatorDescription());
            a.z("WebPaginator", WebPaginatorDescriptionMetadata.a);
        }
    }
    WebPaginatorDescriptionMetadata.$t = /*@__PURE__*/ markType(WebPaginatorDescriptionMetadata, 'WebPaginatorDescriptionMetadata');
