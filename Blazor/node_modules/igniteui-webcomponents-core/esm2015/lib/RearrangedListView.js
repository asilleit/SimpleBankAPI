...
export let RearrangedListView = /*@__PURE__*/ (() => {
    class RearrangedListView extends Base {
        ...
        b1() {
            ...
            let g = this.l == 3 || this.l == 1;
            let h = new List$1(Base.$, 0);
            let i = null;
            let j = null;
            if (this.m.isSectionContentVisible || !this.av) {
                for (let k = 0; k < this.a4.count; k++) {
                    let l = this.a4._inner[k];
                    if (l == null) {
                        continue;
                    }
                    if (i == null) {
                ...
                if (!g) {
                    if (this.j == 1) {
                        for (let s = 0; s < c.length; s++) {
                            ...
                            for (let t = 0; t < this.ag.k.count; t++) {
                        ...
                        if (this.b[0] != null) {
                            for (let v = 0; v < this.ag.k.count; v++) {
                ...
                for (let ah = 0; ah < this.a4.count; ah++) {
                    let ai = this.a4._inner[ah];
                    if (ai == null) {
                        continue;
                    }
                    if (i == null) {
