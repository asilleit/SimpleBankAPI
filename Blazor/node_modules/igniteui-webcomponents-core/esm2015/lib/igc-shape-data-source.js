...
*/
export class IgcShapeDataSource {
    constructor() {
        //@@ZoneRunner
    ...
    */
    ...
    set importPending(ev) {
        ...
        this._importPending_wrapped = (o, e) => {
            let outerArgs = new IgcAsyncCompletedEventArgs();
    ...
    */
    ...
    set filter(ev) {
        ...
        this._filter_wrapped = (o, e) => {
            let outerArgs = new IgcShapeFilterRecordEventArgs();
            outerArgs._provideImplementation(e);
