...
import { IgcDataLegendSeriesValueInfo } from "./igc-data-legend-series-value-info";
...
*/
export class IgcDataLegendSeriesContext {
    ...
    */
    getSeriesValueInfo(type) {
        ...
        if (iv && iv.externalObject) {
            ...
            if (iv) {
                let e = new IgcDataLegendSeriesValueInfo();
