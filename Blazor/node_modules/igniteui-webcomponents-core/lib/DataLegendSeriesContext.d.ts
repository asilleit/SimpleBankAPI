...
import { DataLegendSeriesGroup } from "./DataLegendSeriesGroup";
...
export declare class DataLegendSeriesContext extends Base {
    static $t: Type;
    private d;
    c(a: DataLegendSeriesValueType): DataLegendSeriesValueInfo;
    g(a: DataLegendSeriesValueType): number;
    ...
    private h;
    constructor();
    b: DataLegendSeriesGroup;
    private e;
    f: List$1<DataLegendSeriesValueInfo>;
    a(): number[];
}
