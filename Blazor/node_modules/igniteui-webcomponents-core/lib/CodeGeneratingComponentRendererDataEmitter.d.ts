...
export declare class CodeGeneratingComponentRendererDataEmitter extends Base {
    ...
    private o;
    private m;
    protected readonly p: CodeGenerationRendererOptions;
    protected readonly n: CodeGeneratingRendererResult;
    ...
    private e;
    protected readonly h: CodeGeneratingCodeWriter;
    private d;
    protected readonly g: CodeGeneratingCodeWriter;
    private i;
    protected readonly k: CodeGeneratingImportManager;
    private j;
    protected l: CodeGeneratingImportManager;
    private c;
    protected f: CodeGeneratingCodeWriter;
    ...
    ae(a: string, b: JsonDictionaryItem, c: CodeGeneratingCodeWriter, d: CodeGeneratingImportManager): void;
