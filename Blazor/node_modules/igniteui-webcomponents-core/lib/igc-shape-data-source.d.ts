...
*/
export declare class IgcShapeDataSource {
    ...
    * Gets the point data.
    */
    getPointData(): IgcShapefileRecord[];
    name: string;
    /**
    ...
    */
    ...
    getRecord(index: number): IgcShapefileRecord;
    ...
    */
    importPending: (s: IgcShapeDataSource, e: IgcAsyncCompletedEventArgs) => void;
    private _importCompleted;
    private _importCompleted_wrapped;
    /**
     * Event raised when the Shapefile has been imported from both the ShapefileSource and DatabaseSource Uris.
    */
    importCompleted: (s: IgcShapeDataSource, e: IgcAsyncCompletedEventArgs) => void;
    private _filter;
    private _filter_wrapped;
    filter: (s: IgcShapeDataSource, e: IgcShapeFilterRecordEventArgs) => void;
}
