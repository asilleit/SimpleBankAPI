...
export declare class WebComponentRenderer implements DomRenderer {
    private container;
    ...
    updateRoot(root: WebComponentWrapper): void;
    withRenderer(act: (ren: WebComponentRenderer) => void): void;
    ...
    createElement(elementName: any): WebComponentWrapper;
    createElementNS(elementName: any, ns: any): WebComponentWrapper;
    private _discStack;
    endCSSQuery(): void;
    expandTemplate(template: string, args: any): WebComponentWrapper;
    get2DCanvasContext(canvas: WebComponentWrapper): CanvasRenderingContext2D;
    ...
    hasBody(): boolean;
    hasWindow(): boolean;
    getCurrentDiscovery(): WebComponentWrapper;
...
export declare class WebComponentWrapper implements DomWrapper {
    private renderer;
    constructor(element: any, renderer: WebComponentRenderer);
    private ele;
    destroy(): void;
    withRenderer(act: (ren: WebComponentRenderer) => void): void;
    private _toUnbind;
    ...
    width(): number;
    parent(): WebComponentWrapper;
    querySelectorAll(selector: string): WebComponentWrapper[];
}
...
export declare class PortalManager {
    ...
    private getId;
    getPortal(hostElement: DomWrapper, elementTag: string, portalCallback: (portal: DomPortal) => void, isContentPortal: boolean): void;
    _destroy(portal: WebComponentDomPortal): void;
}
declare class WebComponentDomPortal implements DomPortal {
    private _owner;
    portalContainer: any;
    componentRef: any;
    destroy(): void;
    ...
    constructor(portalManager: PortalManager, hostElement: DomWrapper, elementTag: string, portalCallback: (portal: DomPortal) => void, portalId: string, isContentPortal: boolean);
}
export {};
