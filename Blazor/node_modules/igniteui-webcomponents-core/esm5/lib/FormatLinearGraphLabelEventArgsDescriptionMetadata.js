...
var FormatLinearGraphLabelEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FormatLinearGraphLabelEventArgsDescriptionMetadata.b = function (a) {
        if (FormatLinearGraphLabelEventArgsDescriptionMetadata.a == null) {
            ...
            FormatLinearGraphLabelEventArgsDescriptionMetadata.c(FormatLinearGraphLabelEventArgsDescriptionMetadata.a);
        }
        if (a.j(FormatLinearGraphLabelEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(FormatLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
    FormatLinearGraphLabelEventArgsDescriptionMetadata.c = function (a) {
    };
    FormatLinearGraphLabelEventArgsDescriptionMetadata.d = function (a) {
        FormatLinearGraphLabelEventArgsDescriptionMetadata.b(a);
        a.aa("FormatLinearGraphLabelEventArgs", function () { return new FormatLinearGraphLabelEventArgsDescription(); });
        a.z("FormatLinearGraphLabelEventArgs", FormatLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
