...
var StackedColumnSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedColumnSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(StackedColumnSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(StackedColumnSeriesDescriptionMetadata.a);
    };
    ...
    StackedColumnSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("StackedColumnSeries", function () { return new StackedColumnSeriesDescription(); });
        a.z("StackedColumnSeries", StackedColumnSeriesDescriptionMetadata.a);
    };
