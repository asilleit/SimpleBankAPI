...
var LinearGraphRangeDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LinearGraphRangeDescriptionMetadata.b = function (a) {
        ...
        if (a.j(LinearGraphRangeDescriptionMetadata.a)) {
            return;
        }
        a.y(LinearGraphRangeDescriptionMetadata.a);
    };
    LinearGraphRangeDescriptionMetadata.c = function (a) {
        a.item("Name", "String");
        a.item("Brush", "Brush");
    ...
    LinearGraphRangeDescriptionMetadata.d = function (a) {
        ...
        a.aa("LinearGraphRange", function () { return new LinearGraphRangeDescription(); });
        a.z("LinearGraphRange", LinearGraphRangeDescriptionMetadata.a);
    };
