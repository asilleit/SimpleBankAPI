...
var ToolActionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ToolActionDescriptionMetadata, _super);
    ...
    ToolActionDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ToolActionDescriptionMetadata.a)) {
            return;
        }
        a.y(ToolActionDescriptionMetadata.a);
    ...
    ToolActionDescriptionMetadata.d = function (a) {
        ...
        a.aa("ToolAction", function () { return new ToolActionDescription(); });
        a.z("ToolAction", ToolActionDescriptionMetadata.a);
    };
...
var ToolActionEventDetailDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ToolActionEventDetailDescriptionMetadata, _super);
    ...
    ToolActionEventDetailDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ToolActionEventDetailDescriptionMetadata.a)) {
            return;
        }
        a.y(ToolActionEventDetailDescriptionMetadata.a);
    ...
    ToolActionEventDetailDescriptionMetadata.d = function (a) {
        ...
        a.aa("ToolActionEventDetail", function () { return new ToolActionEventDetailDescription(); });
        a.z("ToolActionEventDetail", ToolActionEventDetailDescriptionMetadata.a);
    };
...
var ToolActionPerformedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ToolActionPerformedEventArgsDescriptionMetadata, _super);
    ...
    ToolActionPerformedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ToolActionPerformedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(ToolActionPerformedEventArgsDescriptionMetadata.a);
    ...
    ToolActionPerformedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("ToolActionPerformedEventArgs", function () { return new ToolActionPerformedEventArgsDescription(); });
        a.z("ToolActionPerformedEventArgs", ToolActionPerformedEventArgsDescriptionMetadata.a);
    };
