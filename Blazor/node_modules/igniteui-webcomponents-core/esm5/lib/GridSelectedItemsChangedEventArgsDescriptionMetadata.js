...
var GridSelectedItemsChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridSelectedItemsChangedEventArgsDescriptionMetadata.b = function (a) {
        if (GridSelectedItemsChangedEventArgsDescriptionMetadata.a == null) {
            ...
            GridSelectedItemsChangedEventArgsDescriptionMetadata.c(GridSelectedItemsChangedEventArgsDescriptionMetadata.a);
        }
        if (a.j(GridSelectedItemsChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridSelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
    GridSelectedItemsChangedEventArgsDescriptionMetadata.c = function (a) {
        a.item("CurrentItems", "Collection:object:GridSelectedItemsCollection:Object");
        a.item("AddedItems", "Collection:object:GridSelectedItemsCollection:Object");
        a.item("RemovedItems", "Collection:object:GridSelectedItemsCollection:Object");
    };
    GridSelectedItemsChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridSelectedItemsChangedEventArgs", function () { return new GridSelectedItemsChangedEventArgsDescription(); });
        a.z("GridSelectedItemsChangedEventArgs", GridSelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
