...
var CalloutStyleUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutStyleUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CalloutStyleUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(CalloutStyleUpdatingEventArgsDescriptionMetadata.a);
    ...
    CalloutStyleUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("CalloutStyleUpdatingEventArgs", function () { return new CalloutStyleUpdatingEventArgsDescription(); });
        a.z("CalloutStyleUpdatingEventArgs", CalloutStyleUpdatingEventArgsDescriptionMetadata.a);
    };
