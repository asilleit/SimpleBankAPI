 ...
 * @hidden
 */
var DotNetCodeGeneratingComponentRendererTemplateEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(DotNetCodeGeneratingComponentRendererTemplateEmitter, _super);
    ...
    return DotNetCodeGeneratingComponentRendererTemplateEmitter;
}(CodeGeneratingComponentRendererTemplateEmitter));
export { DotNetCodeGeneratingComponentRendererTemplateEmitter };
