...
var WebTreeItemComponentEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebTreeItemComponentEventArgsDescriptionMetadata, _super);
    ...
    WebTreeItemComponentEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebTreeItemComponentEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(WebTreeItemComponentEventArgsDescriptionMetadata.a);
    ...
    WebTreeItemComponentEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebTreeItemComponentEventArgs", function () { return new WebTreeItemComponentEventArgsDescription(); });
        a.z("WebTreeItemComponentEventArgs", WebTreeItemComponentEventArgsDescriptionMetadata.a);
    };
