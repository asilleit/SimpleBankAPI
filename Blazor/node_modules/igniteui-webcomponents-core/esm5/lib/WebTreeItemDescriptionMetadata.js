...
var WebTreeItemDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebTreeItemDescriptionMetadata, _super);
    ...
    WebTreeItemDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebTreeItemDescriptionMetadata.a)) {
            return;
        }
        a.y(WebTreeItemDescriptionMetadata.a);
    ...
    WebTreeItemDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebTreeItem", function () { return new WebTreeItemDescription(); });
        a.z("WebTreeItem", WebTreeItemDescriptionMetadata.a);
    };
