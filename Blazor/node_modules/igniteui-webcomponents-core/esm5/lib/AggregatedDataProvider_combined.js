...
var AggregatedDataProvider = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(AggregatedDataProvider, _super);
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "f", {
        get: function () {
            return this.c;
        },
        set: function (a) {
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "w", {
        get: function () {
            return this.r;
        },
        set: function (a) {
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "m", {
        get: function () {
            return this.j;
        },
        set: function (a) {
    ...
    AggregatedDataProvider.prototype.t = function (a, b) {
        ...
        for (var d = 0; d < a.length; d++) {
            ...
            var e = c;
            try {
                for (var _b = (e_1 = void 0, tslib_1.__values(fromEnum(b))), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var f = _c.value;
                    if (e[f] == null) {
                        e[f] = NaN;
                    }
    ...
    AggregatedDataProvider.prototype.e = function (a) {
        ...
        while (a.groupDescriptions.k.count > 1) {
            a.groupDescriptions.removeAt(a.groupDescriptions.k.count - 1);
        }
        if (a.summaryDescriptions.k.count == 0) {
...
var AggregatedDataProviderTargetDataSourceNotifier = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(AggregatedDataProviderTargetDataSourceNotifier, _super);
