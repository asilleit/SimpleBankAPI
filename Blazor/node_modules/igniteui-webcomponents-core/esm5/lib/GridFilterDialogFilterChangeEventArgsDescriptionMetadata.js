...
var GridFilterDialogFilterChangeEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogFilterChangeEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a);
    ...
    GridFilterDialogFilterChangeEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridFilterDialogFilterChangeEventArgs", function () { return new GridFilterDialogFilterChangeEventArgsDescription(); });
        a.z("GridFilterDialogFilterChangeEventArgs", GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a);
    };
