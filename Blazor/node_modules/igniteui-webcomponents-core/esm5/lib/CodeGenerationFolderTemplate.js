    ...
    CodeGenerationFolderTemplate.prototype.execute = function (a) {
        ...
        try {
            for (var _c = tslib_1.__values(fromEnum(a.getNewFiles())), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                var ah = "";
                try {
                    for (var _e = (e_2 = void 0, tslib_1.__values(fromEnum(this.e))), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var ai = _f.value;
    ...
    CodeGenerationFolderTemplate.prototype.k = function (a, b, c, d) {
        ...
        var _loop_2 = function (g) {
            ...
            b = h.execute(b, function (i, j, k) {
                ...
                try {
                    for (var _b = (e_4 = void 0, tslib_1.__values(fromEnum(l))), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var n = _c.value;
