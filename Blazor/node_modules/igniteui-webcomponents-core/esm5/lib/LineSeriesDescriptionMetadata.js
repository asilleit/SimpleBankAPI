...
var LineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(LineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(LineSeriesDescriptionMetadata.a);
    };
    LineSeriesDescriptionMetadata.c = function (a) {
    ...
    LineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("LineSeries", function () { return new LineSeriesDescription(); });
        a.z("LineSeries", LineSeriesDescriptionMetadata.a);
    };
