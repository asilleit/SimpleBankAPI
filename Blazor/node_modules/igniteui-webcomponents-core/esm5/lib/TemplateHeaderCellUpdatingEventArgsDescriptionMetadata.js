...
var TemplateHeaderCellUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.b = function (a) {
        if (TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a == null) {
            ...
            TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.c(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
        }
        if (a.j(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
    };
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.c = function (a) {
    };
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("TemplateHeaderCellUpdatingEventArgs", function () { return new TemplateHeaderCellUpdatingEventArgsDescription(); });
        a.z("TemplateHeaderCellUpdatingEventArgs", TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
    };
