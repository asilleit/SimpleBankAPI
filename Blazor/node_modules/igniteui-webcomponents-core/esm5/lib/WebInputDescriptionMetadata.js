...
var WebInputDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebInputDescriptionMetadata, _super);
    ...
    WebInputDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebInputDescriptionMetadata.a)) {
            return;
        }
        a.y(WebInputDescriptionMetadata.a);
    ...
    WebInputDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebInput", function () { return new WebInputDescription(); });
        a.z("WebInput", WebInputDescriptionMetadata.a);
    };
