...
var SplineFragmentBaseDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineFragmentBaseDescriptionMetadata.b = function (a) {
        if (SplineFragmentBaseDescriptionMetadata.a == null) {
            ...
            SplineFragmentBaseDescriptionMetadata.c(SplineFragmentBaseDescriptionMetadata.a);
        }
        if (a.j(SplineFragmentBaseDescriptionMetadata.a)) {
            return;
        }
        a.y(SplineFragmentBaseDescriptionMetadata.a);
    };
    SplineFragmentBaseDescriptionMetadata.c = function (a) {
    ...
    SplineFragmentBaseDescriptionMetadata.d = function (a) {
        ...
        a.z("SplineFragmentBase", SplineFragmentBaseDescriptionMetadata.a);
    };
