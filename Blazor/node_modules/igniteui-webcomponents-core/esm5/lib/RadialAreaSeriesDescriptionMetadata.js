...
var RadialAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(RadialAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(RadialAreaSeriesDescriptionMetadata.a);
    };
    ...
    RadialAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("RadialAreaSeries", function () { return new RadialAreaSeriesDescription(); });
        a.z("RadialAreaSeries", RadialAreaSeriesDescriptionMetadata.a);
    };
