...
var GridAnimationSettingsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridAnimationSettingsDescriptionMetadata.b = function (a) {
        if (GridAnimationSettingsDescriptionMetadata.a == null) {
            ...
            GridAnimationSettingsDescriptionMetadata.c(GridAnimationSettingsDescriptionMetadata.a);
        }
        if (a.j(GridAnimationSettingsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridAnimationSettingsDescriptionMetadata.a);
    };
    GridAnimationSettingsDescriptionMetadata.c = function (a) {
    };
    GridAnimationSettingsDescriptionMetadata.d = function (a) {
        GridAnimationSettingsDescriptionMetadata.b(a);
        a.aa("GridAnimationSettings", function () { return new GridAnimationSettingsDescription(); });
        a.z("GridAnimationSettings", GridAnimationSettingsDescriptionMetadata.a);
    };
