...
var SyncableObservableCollection$2 = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function SyncableObservableCollection$2($t1, $t2, a) {
        ...
        _this.g = false;
        _this._inner = null;
        _this.p = new List$1(SyncableObservableCollectionChangedListener_$type, 0);
        _this.f = null;
        _this.$t1 = $t1;
        _this.$t2 = $t2;
            ...
            case 0:
                {
                    ...
                    _this.addListener(runOn(_this, _this.ag));
                    var c = _this._inner;
                    c.collectionChanged = delegateCombine(c.collectionChanged, runOn(_this, _this.w));
                }
                break;
            case 1:
                {
    ...
    SyncableObservableCollection$2.prototype.ai = function () {
        if (this.a == null) {
            return;
        }
        this.h = true;
    ...
    SyncableObservableCollection$2.prototype.al = function (a, b) {
        if (this.a == null) {
            return;
        }
        if (this.h) {
    ...
    SyncableObservableCollection$2.prototype.ac = function (a) {
    };
    ...
    SyncableObservableCollection$2.prototype.ah = function ($t, $f, a, b, c) {
        var e_2, _a;
        switch (a.action) {
            case 0:
                if (a.newItems != null) {
    ...
    SyncableObservableCollection$2.prototype.aa = function (a) {
        if (this._inner != null) {
            var b = this._inner;
    ...
    SyncableObservableCollection$2.prototype.w = function (a, b) {
        var e_3, _a;
        if (this.f != null) {
            this.f();
        }
        try {
            for (var _b = tslib_1.__values(fromEnum(this.p)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                c.onChanged(this);
            }
        }
