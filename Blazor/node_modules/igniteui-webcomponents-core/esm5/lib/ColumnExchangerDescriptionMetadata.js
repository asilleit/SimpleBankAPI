...
var ColumnExchangerDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnExchangerDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ColumnExchangerDescriptionMetadata.a)) {
            return;
        }
        a.y(ColumnExchangerDescriptionMetadata.a);
    };
    ...
    ColumnExchangerDescriptionMetadata.d = function (a) {
        ...
        a.aa("ColumnExchanger", function () { return new ColumnExchangerDescription(); });
        a.z("ColumnExchanger", ColumnExchangerDescriptionMetadata.a);
    };
