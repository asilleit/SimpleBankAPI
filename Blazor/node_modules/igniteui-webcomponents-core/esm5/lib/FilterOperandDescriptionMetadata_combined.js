...
var FilterOperandDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(FilterOperandDescriptionMetadata, _super);
    ...
    FilterOperandDescriptionMetadata.b = function (a) {
        ...
        if (a.j(FilterOperandDescriptionMetadata.a)) {
            return;
        }
        a.y(FilterOperandDescriptionMetadata.a);
    ...
    FilterOperandDescriptionMetadata.d = function (a) {
        ...
        a.aa("FilterOperand", function () { return new FilterOperandDescription(); });
        a.z("FilterOperand", FilterOperandDescriptionMetadata.a);
    };
...
var GridCustomFilterRequestedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(GridCustomFilterRequestedEventArgsDescriptionMetadata, _super);
    ...
    GridCustomFilterRequestedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridCustomFilterRequestedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridCustomFilterRequestedEventArgsDescriptionMetadata.a);
    ...
    GridCustomFilterRequestedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridCustomFilterRequestedEventArgs", function () { return new GridCustomFilterRequestedEventArgsDescription(); });
        a.z("GridCustomFilterRequestedEventArgs", GridCustomFilterRequestedEventArgsDescriptionMetadata.a);
    };
