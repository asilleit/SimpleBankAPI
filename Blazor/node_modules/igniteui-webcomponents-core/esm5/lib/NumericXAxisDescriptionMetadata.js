...
var NumericXAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericXAxisDescriptionMetadata.b = function (a) {
        if (NumericXAxisDescriptionMetadata.a == null) {
            ...
            NumericXAxisDescriptionMetadata.c(NumericXAxisDescriptionMetadata.a);
        }
        if (a.j(NumericXAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(NumericXAxisDescriptionMetadata.a);
    };
    NumericXAxisDescriptionMetadata.c = function (a) {
    ...
    NumericXAxisDescriptionMetadata.d = function (a) {
        ...
        a.aa("NumericXAxis", function () { return new NumericXAxisDescription(); });
        a.z("NumericXAxis", NumericXAxisDescriptionMetadata.a);
    };
