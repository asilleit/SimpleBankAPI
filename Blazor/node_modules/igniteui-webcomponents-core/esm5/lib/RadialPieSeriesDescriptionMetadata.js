...
var RadialPieSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialPieSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(RadialPieSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(RadialPieSeriesDescriptionMetadata.a);
    };
    ...
    RadialPieSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("RadialPieSeries", function () { return new RadialPieSeriesDescription(); });
        a.z("RadialPieSeries", RadialPieSeriesDescriptionMetadata.a);
    };
