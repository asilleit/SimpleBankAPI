...
var CategoryDateTimeXAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryDateTimeXAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CategoryDateTimeXAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(CategoryDateTimeXAxisDescriptionMetadata.a);
    };
    CategoryDateTimeXAxisDescriptionMetadata.c = function (a) {
    ...
    CategoryDateTimeXAxisDescriptionMetadata.d = function (a) {
        ...
        a.aa("CategoryDateTimeXAxis", function () { return new CategoryDateTimeXAxisDescription(); });
        a.z("CategoryDateTimeXAxis", CategoryDateTimeXAxisDescriptionMetadata.a);
    };
