...
var PolarSplineAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarSplineAreaSeriesDescriptionMetadata.b = function (a) {
        if (PolarSplineAreaSeriesDescriptionMetadata.a == null) {
            ...
            PolarSplineAreaSeriesDescriptionMetadata.c(PolarSplineAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(PolarSplineAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(PolarSplineAreaSeriesDescriptionMetadata.a);
    };
    PolarSplineAreaSeriesDescriptionMetadata.c = function (a) {
        PolarLineSeriesBaseDescriptionMetadata.c(a);
        a.item("Stiffness", "Number:double");
    };
    PolarSplineAreaSeriesDescriptionMetadata.d = function (a) {
        PolarSplineAreaSeriesDescriptionMetadata.b(a);
        a.aa("PolarSplineAreaSeries", function () { return new PolarSplineAreaSeriesDescription(); });
        a.z("PolarSplineAreaSeries", PolarSplineAreaSeriesDescriptionMetadata.a);
    };
