 ...
 * @hidden
 */
var WebRowSelectionEventArgsDetailDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebRowSelectionEventArgsDetailDescriptionMetadata, _super);
    function WebRowSelectionEventArgsDetailDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WebRowSelectionEventArgsDetailDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebRowSelectionEventArgsDetailDescriptionMetadata.a)) {
            return;
        }
        a.y(WebRowSelectionEventArgsDetailDescriptionMetadata.a);
    };
    WebRowSelectionEventArgsDetailDescriptionMetadata.c = function (a) {
    ...
    WebRowSelectionEventArgsDetailDescriptionMetadata.d = function (a) {
        WebRowSelectionEventArgsDetailDescriptionMetadata.b(a);
        a.aa("WebRowSelectionEventArgsDetail", function () { return new WebRowSelectionEventArgsDetailDescription(); });
        a.z("WebRowSelectionEventArgsDetail", WebRowSelectionEventArgsDetailDescriptionMetadata.a);
    };
    WebRowSelectionEventArgsDetailDescriptionMetadata.$t = markType(WebRowSelectionEventArgsDetailDescriptionMetadata, 'WebRowSelectionEventArgsDetailDescriptionMetadata');
    WebRowSelectionEventArgsDetailDescriptionMetadata.a = null;
    return WebRowSelectionEventArgsDetailDescriptionMetadata;
}(Base));
export { WebRowSelectionEventArgsDetailDescriptionMetadata };
