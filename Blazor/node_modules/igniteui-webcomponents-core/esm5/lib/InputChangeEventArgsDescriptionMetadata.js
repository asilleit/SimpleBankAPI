...
var InputChangeEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    InputChangeEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(InputChangeEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(InputChangeEventArgsDescriptionMetadata.a);
    };
    InputChangeEventArgsDescriptionMetadata.c = function (a) {
        a.item("Value", "String");
    ...
    InputChangeEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("InputChangeEventArgs", function () { return new InputChangeEventArgsDescription(); });
        a.z("InputChangeEventArgs", InputChangeEventArgsDescriptionMetadata.a);
    };
