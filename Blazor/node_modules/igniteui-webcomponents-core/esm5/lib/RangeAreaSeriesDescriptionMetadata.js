...
var RangeAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeAreaSeriesDescriptionMetadata.b = function (a) {
        if (RangeAreaSeriesDescriptionMetadata.a == null) {
            ...
            RangeAreaSeriesDescriptionMetadata.c(RangeAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(RangeAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(RangeAreaSeriesDescriptionMetadata.a);
    };
    RangeAreaSeriesDescriptionMetadata.c = function (a) {
    ...
    RangeAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("RangeAreaSeries", function () { return new RangeAreaSeriesDescription(); });
        a.z("RangeAreaSeries", RangeAreaSeriesDescriptionMetadata.a);
    };
