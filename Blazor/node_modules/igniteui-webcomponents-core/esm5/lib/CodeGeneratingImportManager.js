...
var CodeGeneratingImportManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CodeGeneratingImportManager.merge = function (a, b) {
        ...
        if (b.f.count > 0 || a.f.count > 0) {
            try {
                for (var _g = tslib_1.__values(fromEnum(a.f.keys)), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var d = _h.value;
                    try {
                        for (var _j = (e_2 = void 0, tslib_1.__values(fromEnum(a.f.item(d)))), _k = _j.next(); !_k.done; _k = _j.next()) {
                            var e = _k.value;
                            if (a.h.contains(d)) {
            ...
            try {
                for (var _l = tslib_1.__values(fromEnum(b.f.keys)), _m = _l.next(); !_m.done; _m = _l.next()) {
                    var f = _m.value;
                    try {
                        for (var _o = (e_4 = void 0, tslib_1.__values(fromEnum(b.f.item(f)))), _p = _o.next(); !_p.done; _p = _o.next()) {
                            var g = _p.value;
                            if (b.h.contains(f)) {
            ...
            try {
                for (var _q = tslib_1.__values(fromEnum(a.k)), _r = _q.next(); !_r.done; _r = _q.next()) {
                    var h = _r.value;
                    c.addUsing(h);
                }
            }
            ...
            try {
                for (var _s = tslib_1.__values(fromEnum(b.k)), _t = _s.next(); !_t.done; _t = _s.next()) {
                    var i = _t.value;
                    c.addUsing(i);
                }
            }
    ...
    CodeGeneratingImportManager.prototype.removeDuplicates = function (a) {
        ...
        if (a.f.count > 0) {
            try {
                for (var _d = tslib_1.__values(fromEnum(a.f.keys)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var c = _e.value;
                    if (this.f.containsKey(c)) {
                        try {
                            for (var _f = (e_8 = void 0, tslib_1.__values(fromEnum(a.f.item(c)))), _g = _f.next(); !_g.done; _g = _f.next()) {
                                var d = _g.value;
            ...
            try {
                for (var _h = tslib_1.__values(fromEnum(a.k)), _j = _h.next(); !_j.done; _j = _h.next()) {
                    var e = _j.value;
                    if (b.i.contains(e)) {
                        b.i.remove(e);
                        b.k.remove(e);
