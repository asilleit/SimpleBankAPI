...
var TemplateCellUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TemplateCellUpdatingEventArgsDescriptionMetadata.b = function (a) {
        if (TemplateCellUpdatingEventArgsDescriptionMetadata.a == null) {
            ...
            TemplateCellUpdatingEventArgsDescriptionMetadata.c(TemplateCellUpdatingEventArgsDescriptionMetadata.a);
        }
        if (a.j(TemplateCellUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(TemplateCellUpdatingEventArgsDescriptionMetadata.a);
    };
    TemplateCellUpdatingEventArgsDescriptionMetadata.c = function (a) {
    };
    TemplateCellUpdatingEventArgsDescriptionMetadata.d = function (a) {
        TemplateCellUpdatingEventArgsDescriptionMetadata.b(a);
        a.aa("TemplateCellUpdatingEventArgs", function () { return new TemplateCellUpdatingEventArgsDescription(); });
        a.z("TemplateCellUpdatingEventArgs", TemplateCellUpdatingEventArgsDescriptionMetadata.a);
    };
