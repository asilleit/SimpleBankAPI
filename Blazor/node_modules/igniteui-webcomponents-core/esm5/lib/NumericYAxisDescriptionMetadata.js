...
var NumericYAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericYAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.j(NumericYAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(NumericYAxisDescriptionMetadata.a);
    };
    ...
    NumericYAxisDescriptionMetadata.d = function (a) {
        ...
        a.aa("NumericYAxis", function () { return new NumericYAxisDescription(); });
        a.z("NumericYAxis", NumericYAxisDescriptionMetadata.a);
    };
