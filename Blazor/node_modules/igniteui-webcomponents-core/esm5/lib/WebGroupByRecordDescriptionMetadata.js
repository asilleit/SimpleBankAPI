...
var WebGroupByRecordDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebGroupByRecordDescriptionMetadata, _super);
    ...
    WebGroupByRecordDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebGroupByRecordDescriptionMetadata.a)) {
            return;
        }
        a.y(WebGroupByRecordDescriptionMetadata.a);
    ...
    WebGroupByRecordDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebGroupByRecord", function () { return new WebGroupByRecordDescription(); });
        a.z("WebGroupByRecord", WebGroupByRecordDescriptionMetadata.a);
    };
