...
var ShapeFilterRecordEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ShapeFilterRecordEventArgsDescriptionMetadata.b = function (a) {
        if (ShapeFilterRecordEventArgsDescriptionMetadata.a == null) {
            ...
            ShapeFilterRecordEventArgsDescriptionMetadata.c(ShapeFilterRecordEventArgsDescriptionMetadata.a);
        }
        if (a.j(ShapeFilterRecordEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(ShapeFilterRecordEventArgsDescriptionMetadata.a);
        ShapefileRecordDescriptionMetadata.d(a);
    };
    ShapeFilterRecordEventArgsDescriptionMetadata.c = function (a) {
        a.item("Record", "ExportedType:ShapefileRecord");
        a.item("ShouldInclude", "Boolean");
    };
    ShapeFilterRecordEventArgsDescriptionMetadata.d = function (a) {
        ShapeFilterRecordEventArgsDescriptionMetadata.b(a);
        a.aa("ShapeFilterRecordEventArgs", function () { return new ShapeFilterRecordEventArgsDescription(); });
        a.z("ShapeFilterRecordEventArgs", ShapeFilterRecordEventArgsDescriptionMetadata.a);
    };
