...
var CustomIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CustomIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CustomIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(CustomIndicatorDescriptionMetadata.a);
    };
    ...
    CustomIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("CustomIndicator", function () { return new CustomIndicatorDescription(); });
        a.z("CustomIndicator", CustomIndicatorDescriptionMetadata.a);
    };
