...
var AssigningCategoryStyleEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AssigningCategoryStyleEventArgsDescriptionMetadata.b = function (a) {
        if (AssigningCategoryStyleEventArgsDescriptionMetadata.a == null) {
            ...
            AssigningCategoryStyleEventArgsDescriptionMetadata.c(AssigningCategoryStyleEventArgsDescriptionMetadata.a);
        }
        if (a.j(AssigningCategoryStyleEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(AssigningCategoryStyleEventArgsDescriptionMetadata.a);
    };
    AssigningCategoryStyleEventArgsDescriptionMetadata.c = function (a) {
    ...
    AssigningCategoryStyleEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("AssigningCategoryStyleEventArgs", function () { return new AssigningCategoryStyleEventArgsDescription(); });
        a.z("AssigningCategoryStyleEventArgs", AssigningCategoryStyleEventArgsDescriptionMetadata.a);
    };
