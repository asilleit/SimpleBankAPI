...
var TextHeaderDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TextHeaderDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TextHeaderDescriptionMetadata.a)) {
            return;
        }
        a.y(TextHeaderDescriptionMetadata.a);
    };
    ...
    TextHeaderDescriptionMetadata.d = function (a) {
        ...
        a.aa("TextHeader", function () { return new TextHeaderDescription(); });
        a.z("TextHeader", TextHeaderDescriptionMetadata.a);
    };
