...
var DomainChartSeriesPointerEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DomainChartSeriesPointerEventArgsDescriptionMetadata.b = function (a) {
        if (DomainChartSeriesPointerEventArgsDescriptionMetadata.a == null) {
            ...
            DomainChartSeriesPointerEventArgsDescriptionMetadata.c(DomainChartSeriesPointerEventArgsDescriptionMetadata.a);
        }
        if (a.j(DomainChartSeriesPointerEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(DomainChartSeriesPointerEventArgsDescriptionMetadata.a);
        SeriesDescriptionMetadata.d(a);
    };
    DomainChartSeriesPointerEventArgsDescriptionMetadata.c = function (a) {
    ...
    DomainChartSeriesPointerEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("DomainChartSeriesPointerEventArgs", function () { return new DomainChartSeriesPointerEventArgsDescription(); });
        a.z("DomainChartSeriesPointerEventArgs", DomainChartSeriesPointerEventArgsDescriptionMetadata.a);
    };
