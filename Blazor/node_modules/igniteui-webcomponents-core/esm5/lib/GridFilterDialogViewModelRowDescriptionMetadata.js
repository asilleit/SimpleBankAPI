...
var GridFilterDialogViewModelRowDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogViewModelRowDescriptionMetadata.b = function (a) {
        if (GridFilterDialogViewModelRowDescriptionMetadata.a == null) {
            ...
            GridFilterDialogViewModelRowDescriptionMetadata.c(GridFilterDialogViewModelRowDescriptionMetadata.a);
        }
        if (a.j(GridFilterDialogViewModelRowDescriptionMetadata.a)) {
            return;
        }
        a.y(GridFilterDialogViewModelRowDescriptionMetadata.a);
    };
    GridFilterDialogViewModelRowDescriptionMetadata.c = function (a) {
        a.item("Operators", "Array:string");
        a.item("CurrentOperator", "String");
        a.item("OperandNumber", "Array:int");
        a.item("Operand1Ref", "(w:Operand1,wf:Operand1)DataRef");
        a.item("Operand2Ref", "(w:Operand2,wf:Operand2)DataRef");
    };
    GridFilterDialogViewModelRowDescriptionMetadata.d = function (a) {
        GridFilterDialogViewModelRowDescriptionMetadata.b(a);
        a.aa("GridFilterDialogViewModelRow", function () { return new GridFilterDialogViewModelRowDescription(); });
        a.z("GridFilterDialogViewModelRow", GridFilterDialogViewModelRowDescriptionMetadata.a);
    };
