...
var GridCellValueChangingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridCellValueChangingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridCellValueChangingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridCellValueChangingEventArgsDescriptionMetadata.a);
        CellInfoDescriptionMetadata.d(a);
        DataGridColumnDescriptionMetadata.d(a);
    };
    GridCellValueChangingEventArgsDescriptionMetadata.c = function (a) {
    ...
    GridCellValueChangingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridCellValueChangingEventArgs", function () { return new GridCellValueChangingEventArgsDescription(); });
        a.z("GridCellValueChangingEventArgs", GridCellValueChangingEventArgsDescriptionMetadata.a);
    };
