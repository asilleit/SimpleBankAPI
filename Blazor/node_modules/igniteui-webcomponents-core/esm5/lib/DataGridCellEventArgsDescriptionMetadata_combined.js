...
var DataGridCellEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(DataGridCellEventArgsDescriptionMetadata, _super);
    ...
    DataGridCellEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(DataGridCellEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(DataGridCellEventArgsDescriptionMetadata.a);
    ...
    DataGridCellEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("DataGridCellEventArgs", function () { return new DataGridCellEventArgsDescription(); });
        a.z("DataGridCellEventArgs", DataGridCellEventArgsDescriptionMetadata.a);
    };
...
var DataGridDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataGridDescriptionMetadata.b = function (a) {
        ...
        if (a.j(DataGridDescriptionMetadata.a)) {
            return;
        }
        a.y(DataGridDescriptionMetadata.a);
    ...
    DataGridDescriptionMetadata.d = function (a) {
        ...
        a.aa("DataGrid", function () { return new DataGridDescription(); });
        a.z("DataGrid", DataGridDescriptionMetadata.a);
    };
