...
var MarketFacilitationIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    MarketFacilitationIndexIndicatorDescriptionMetadata.b = function (a) {
        if (MarketFacilitationIndexIndicatorDescriptionMetadata.a == null) {
            ...
            MarketFacilitationIndexIndicatorDescriptionMetadata.c(MarketFacilitationIndexIndicatorDescriptionMetadata.a);
        }
        if (a.j(MarketFacilitationIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(MarketFacilitationIndexIndicatorDescriptionMetadata.a);
    };
    MarketFacilitationIndexIndicatorDescriptionMetadata.c = function (a) {
    ...
    MarketFacilitationIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("MarketFacilitationIndexIndicator", function () { return new MarketFacilitationIndexIndicatorDescription(); });
        a.z("MarketFacilitationIndexIndicator", MarketFacilitationIndexIndicatorDescriptionMetadata.a);
    };
