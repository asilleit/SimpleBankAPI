...
var WebSnackbarDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebSnackbarDescriptionMetadata, _super);
    ...
    WebSnackbarDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebSnackbarDescriptionMetadata.a)) {
            return;
        }
        a.y(WebSnackbarDescriptionMetadata.a);
    ...
    WebSnackbarDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebSnackbar", function () { return new WebSnackbarDescription(); });
        a.z("WebSnackbar", WebSnackbarDescriptionMetadata.a);
    };
