...
var FullStochasticOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FullStochasticOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(FullStochasticOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(FullStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    FullStochasticOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("FullStochasticOscillatorIndicator", function () { return new FullStochasticOscillatorIndicatorDescription(); });
        a.z("FullStochasticOscillatorIndicator", FullStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
