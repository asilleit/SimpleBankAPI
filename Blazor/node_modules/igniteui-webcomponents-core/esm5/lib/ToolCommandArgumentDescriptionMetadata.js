...
var ToolCommandArgumentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ToolCommandArgumentDescriptionMetadata, _super);
    ...
    ToolCommandArgumentDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ToolCommandArgumentDescriptionMetadata.a)) {
            return;
        }
        a.y(ToolCommandArgumentDescriptionMetadata.a);
    };
    ...
    ToolCommandArgumentDescriptionMetadata.d = function (a) {
        ...
        a.aa("ToolCommandArgument", function () { return new ToolCommandArgumentDescription(); });
        a.z("ToolCommandArgument", ToolCommandArgumentDescriptionMetadata.a);
    };
