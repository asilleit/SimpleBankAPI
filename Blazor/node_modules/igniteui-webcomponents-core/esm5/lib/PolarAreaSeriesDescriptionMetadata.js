...
var PolarAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarAreaSeriesDescriptionMetadata.b = function (a) {
        if (PolarAreaSeriesDescriptionMetadata.a == null) {
            ...
            PolarAreaSeriesDescriptionMetadata.c(PolarAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(PolarAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(PolarAreaSeriesDescriptionMetadata.a);
    };
    PolarAreaSeriesDescriptionMetadata.c = function (a) {
    ...
    PolarAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("PolarAreaSeries", function () { return new PolarAreaSeriesDescription(); });
        a.z("PolarAreaSeries", PolarAreaSeriesDescriptionMetadata.a);
    };
