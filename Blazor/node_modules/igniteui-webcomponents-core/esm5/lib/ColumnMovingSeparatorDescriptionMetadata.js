...
var ColumnMovingSeparatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnMovingSeparatorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ColumnMovingSeparatorDescriptionMetadata.a)) {
            return;
        }
        a.y(ColumnMovingSeparatorDescriptionMetadata.a);
    };
    ...
    ColumnMovingSeparatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("ColumnMovingSeparator", function () { return new ColumnMovingSeparatorDescription(); });
        a.z("ColumnMovingSeparator", ColumnMovingSeparatorDescriptionMetadata.a);
    };
