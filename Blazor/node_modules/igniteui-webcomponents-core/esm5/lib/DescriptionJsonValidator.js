...
var DescriptionJsonValidator = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(DescriptionJsonValidator, _super);
    ...
    DescriptionJsonValidator.prototype.validate = function (a) {
        ...
        for (var k = 0; k < d.length; k++) {
            ...
            if (!m) {
                ...
                var s = q.d;
                var t = s + ("\"" + j + "\"").length;
                i = this.f(i, r, s, r, t, "Type " + j + " appears not to have a containing module, consider adding one of: " + stringJoin.apply(void 0, tslib_1.__spread([", "], l)));
            }
        }
    ...
    DescriptionJsonValidator.prototype.toJson = function () {
        ...
        try {
            for (var _c = tslib_1.__values(fromEnum(this.i)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var d = _d.value;
                _loop_1(d);
            }
        }
        ...
        var _loop_2 = function (f) {
            ...
            try {
                for (var _b = (e_4 = void 0, tslib_1.__values(fromEnum(this_1.h.item(f)))), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var h = _c.value;
                    _loop_3(h);
                }
            }
        ...
        var this_1 = this;
        try {
            for (var _e = tslib_1.__values(fromEnum(this.h.keys)), _f = _e.next(); !_f.done; _f = _e.next()) {
                var f = _f.value;
                _loop_2(f);
            }
        }
