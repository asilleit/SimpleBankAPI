...
var BollingerBandWidthIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BollingerBandWidthIndicatorDescriptionMetadata.b = function (a) {
        if (BollingerBandWidthIndicatorDescriptionMetadata.a == null) {
            ...
            BollingerBandWidthIndicatorDescriptionMetadata.c(BollingerBandWidthIndicatorDescriptionMetadata.a);
        }
        if (a.j(BollingerBandWidthIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(BollingerBandWidthIndicatorDescriptionMetadata.a);
    };
    BollingerBandWidthIndicatorDescriptionMetadata.c = function (a) {
    ...
    BollingerBandWidthIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("BollingerBandWidthIndicator", function () { return new BollingerBandWidthIndicatorDescription(); });
        a.z("BollingerBandWidthIndicator", BollingerBandWidthIndicatorDescriptionMetadata.a);
    };
