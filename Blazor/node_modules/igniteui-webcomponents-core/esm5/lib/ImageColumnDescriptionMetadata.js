...
var ImageColumnDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ImageColumnDescriptionMetadata.b = function (a) {
        if (ImageColumnDescriptionMetadata.a == null) {
            ...
            ImageColumnDescriptionMetadata.c(ImageColumnDescriptionMetadata.a);
        }
        if (a.j(ImageColumnDescriptionMetadata.a)) {
            return;
        }
        a.y(ImageColumnDescriptionMetadata.a);
    };
    ImageColumnDescriptionMetadata.c = function (a) {
    ...
    ImageColumnDescriptionMetadata.d = function (a) {
        ...
        a.aa("ImageColumn", function () { return new ImageColumnDescription(); });
        a.z("ImageColumn", ImageColumnDescriptionMetadata.a);
    };
