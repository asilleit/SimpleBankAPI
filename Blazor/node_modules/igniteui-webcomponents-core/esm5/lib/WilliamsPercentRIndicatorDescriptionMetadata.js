...
var WilliamsPercentRIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WilliamsPercentRIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WilliamsPercentRIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(WilliamsPercentRIndicatorDescriptionMetadata.a);
    };
    ...
    WilliamsPercentRIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("WilliamsPercentRIndicator", function () { return new WilliamsPercentRIndicatorDescription(); });
        a.z("WilliamsPercentRIndicator", WilliamsPercentRIndicatorDescriptionMetadata.a);
    };
