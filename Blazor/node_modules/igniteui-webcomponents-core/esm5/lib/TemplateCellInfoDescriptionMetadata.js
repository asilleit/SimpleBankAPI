...
var TemplateCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TemplateCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TemplateCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.y(TemplateCellInfoDescriptionMetadata.a);
    };
    TemplateCellInfoDescriptionMetadata.c = function (a) {
    ...
    TemplateCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.aa("TemplateCellInfo", function () { return new TemplateCellInfoDescription(); });
        a.z("TemplateCellInfo", TemplateCellInfoDescriptionMetadata.a);
    };
