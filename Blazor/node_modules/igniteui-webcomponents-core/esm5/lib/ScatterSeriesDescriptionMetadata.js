...
var ScatterSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ScatterSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ScatterSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(ScatterSeriesDescriptionMetadata.a);
    };
    ScatterSeriesDescriptionMetadata.c = function (a) {
        ScatterBaseDescriptionMetadata.c(a);
    };
    ScatterSeriesDescriptionMetadata.d = function (a) {
        ScatterSeriesDescriptionMetadata.b(a);
        a.aa("ScatterSeries", function () { return new ScatterSeriesDescription(); });
        a.z("ScatterSeries", ScatterSeriesDescriptionMetadata.a);
    };
