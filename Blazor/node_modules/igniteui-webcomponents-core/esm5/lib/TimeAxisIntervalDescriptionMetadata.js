...
var TimeAxisIntervalDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TimeAxisIntervalDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TimeAxisIntervalDescriptionMetadata.a)) {
            return;
        }
        a.y(TimeAxisIntervalDescriptionMetadata.a);
    };
    ...
    TimeAxisIntervalDescriptionMetadata.d = function (a) {
        ...
        a.aa("TimeAxisInterval", function () { return new TimeAxisIntervalDescription(); });
        a.z("TimeAxisInterval", TimeAxisIntervalDescriptionMetadata.a);
    };
