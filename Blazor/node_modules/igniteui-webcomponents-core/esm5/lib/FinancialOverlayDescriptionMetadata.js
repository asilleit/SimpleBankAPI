...
var FinancialOverlayDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FinancialOverlayDescriptionMetadata.b = function (a) {
        if (FinancialOverlayDescriptionMetadata.a == null) {
            ...
            FinancialOverlayDescriptionMetadata.c(FinancialOverlayDescriptionMetadata.a);
        }
        if (a.j(FinancialOverlayDescriptionMetadata.a)) {
            return;
        }
        a.y(FinancialOverlayDescriptionMetadata.a);
    };
    FinancialOverlayDescriptionMetadata.c = function (a) {
    ...
    FinancialOverlayDescriptionMetadata.d = function (a) {
        ...
        a.z("FinancialOverlay", FinancialOverlayDescriptionMetadata.a);
    };
