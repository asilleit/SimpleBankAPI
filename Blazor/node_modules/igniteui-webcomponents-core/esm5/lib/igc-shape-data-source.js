...
import { IgcAsyncCompletedEventArgs } from './igc-async-completed-event-args';
import { IgcShapefileRecord } from './igc-shapefile-record';
import { IgcShapeFilterRecordEventArgs } from './igc-shape-filter-record-event-args';
/**
 * Class used to convert Shapefiles into CLR objects.
*/
var IgcShapeDataSource = /** @class */ /*@__PURE__*/ (function () {
    function IgcShapeDataSource() {
        //@@ZoneRunner
    ...
    IgcShapeDataSource.prototype.createImplementation = function () {
        return new ShapefileConverter_internal();
    };
    Object.defineProperty(IgcShapeDataSource.prototype, "i", {
        get: function () {
    ...
    IgcShapeDataSource.prototype.onImplementationCreated = function () {
    };
    IgcShapeDataSource.prototype._provideImplementation = function (i) {
    ...
    //   }
    IgcShapeDataSource.prototype.dataBind = function () {
    ...
    */
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "name", {
        get: function () {
            return this.i.name;
        },
        set: function (v) {
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "worldRect", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "computedWorldRect", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "shapeType", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "shapeHeader", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "deferImportCompleted", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "shapefileSource", {
        /**
         * The Uri of the .shp portion of the Shapefile.
        */
        get: function () {
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "databaseSource", {
        /**
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "count", {
        /**
    ...
    IgcShapeDataSource.prototype.findByName = function (name) {
    ...
    IgcShapeDataSource.prototype.getWorldBounds = function (useComputed) {
        var iv = this.i.getWorldBounds(useComputed);
        return fromRect(iv);
    };
    IgcShapeDataSource.prototype.setWorldBounds = function (setComputed, bounds) {
        this.i.setWorldBounds(setComputed, toRect(bounds));
    };
    IgcShapeDataSource.prototype.sendImportCompleted = function () {
        this.i.sendImportCompleted();
    };
    IgcShapeDataSource.prototype.getRecordsCount = function () {
        var iv = this.i.getRecordsCount();
        return (iv);
    };
    IgcShapeDataSource.prototype.getRecord = function (index) {
    ...
    IgcShapeDataSource.prototype.getRecordBounds = function (index) {
        var iv = this.i.getRecordBounds(index);
        return fromRect(iv);
    };
    IgcShapeDataSource.prototype.getRecordFieldNames = function (index) {
        var iv = this.i.getRecordFieldNames(index);
        return (iv);
    };
    IgcShapeDataSource.prototype.getRecordValue = function (index, fieldName) {
        var iv = this.i.getRecordValue(index, fieldName);
        return (iv);
    };
    IgcShapeDataSource.prototype.removeRecord = function (index) {
        this.i.removeRecord(index);
    };
    IgcShapeDataSource.prototype.shiftAllShapes = function (offsetX, offsetY) {
        this.i.shiftAllShapes(offsetX, offsetY);
    };
    IgcShapeDataSource.prototype.shiftShapes = function (recordIndex, offsetX, offsetY) {
        this.i.shiftShapes(recordIndex, offsetX, offsetY);
    };
    IgcShapeDataSource.prototype.getMaxLongitude = function (recordIndex, useLargestShape, fromLongitude, toLongitude) {
        var iv = this.i.getMaxLongitude(recordIndex, useLargestShape, fromLongitude, toLongitude);
        return (iv);
    };
    IgcShapeDataSource.prototype.setRecordValue = function (index, fieldName, value) {
        this.i.setRecordValue(index, fieldName, value);
    };
    IgcShapeDataSource.prototype.getRecordValues = function (fieldName) {
        var iv = this.i.getRecordValues(fieldName);
        return (iv);
    };
    IgcShapeDataSource.prototype.setRecordValues = function (fieldName, values) {
        this.i.setRecordValues(fieldName, values);
    };
    IgcShapeDataSource.prototype.getLargestShapeBoundsForRecord = function (index) {
        var iv = this.i.getLargestShapeBoundsForRecord(index);
        return fromRect(iv);
    };
    Object.defineProperty(IgcShapeDataSource.prototype, "importPending", {
        /**
        ...
        */
        ...
        set: function (ev) {
            ...
            this._importPending_wrapped = function (o, e) {
                var outerArgs = new IgcAsyncCompletedEventArgs();
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "importCompleted", {
        /**
         * Event raised when the Shapefile has been imported from both the ShapefileSource and DatabaseSource Uris.
        */
        get: function () {
    ...
    Object.defineProperty(IgcShapeDataSource.prototype, "filter", {
        get: function () {
            return this._filter;
        },
        set: function (ev) {
            ...
            this._filter_wrapped = function (o, e) {
                var outerArgs = new IgcShapeFilterRecordEventArgs();
                outerArgs._provideImplementation(e);
    ...
    return IgcShapeDataSource;
}());
export { IgcShapeDataSource };
