...
var SelectedItemsChangingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SelectedItemsChangingEventArgsDescriptionMetadata.b = function (a) {
        if (SelectedItemsChangingEventArgsDescriptionMetadata.a == null) {
            ...
            SelectedItemsChangingEventArgsDescriptionMetadata.c(SelectedItemsChangingEventArgsDescriptionMetadata.a);
        }
        if (a.j(SelectedItemsChangingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(SelectedItemsChangingEventArgsDescriptionMetadata.a);
    };
    SelectedItemsChangingEventArgsDescriptionMetadata.c = function (a) {
        SelectedItemsChangedEventArgsDescriptionMetadata.c(a);
    ...
    SelectedItemsChangingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("SelectedItemsChangingEventArgs", function () { return new SelectedItemsChangingEventArgsDescription(); });
        a.z("SelectedItemsChangingEventArgs", SelectedItemsChangingEventArgsDescriptionMetadata.a);
    };
