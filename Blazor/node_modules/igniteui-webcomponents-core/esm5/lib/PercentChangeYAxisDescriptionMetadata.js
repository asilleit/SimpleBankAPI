...
var PercentChangeYAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PercentChangeYAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.j(PercentChangeYAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(PercentChangeYAxisDescriptionMetadata.a);
    };
    PercentChangeYAxisDescriptionMetadata.c = function (a) {
    ...
    PercentChangeYAxisDescriptionMetadata.d = function (a) {
        ...
        a.aa("PercentChangeYAxis", function () { return new PercentChangeYAxisDescription(); });
        a.z("PercentChangeYAxis", PercentChangeYAxisDescriptionMetadata.a);
    };
