...
var WebCellDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebCellDescriptionMetadata, _super);
    ...
    WebCellDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebCellDescriptionMetadata.a)) {
            return;
        }
        a.y(WebCellDescriptionMetadata.a);
    };
    ...
    WebCellDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebCell", function () { return new WebCellDescription(); });
        a.z("WebCell", WebCellDescriptionMetadata.a);
    };
