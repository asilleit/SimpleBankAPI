...
var WebMaskInputDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebMaskInputDescriptionMetadata, _super);
    ...
    WebMaskInputDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebMaskInputDescriptionMetadata.a)) {
            return;
        }
        a.y(WebMaskInputDescriptionMetadata.a);
    };
    ...
    WebMaskInputDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebMaskInput", function () { return new WebMaskInputDescription(); });
        a.z("WebMaskInput", WebMaskInputDescriptionMetadata.a);
    };
