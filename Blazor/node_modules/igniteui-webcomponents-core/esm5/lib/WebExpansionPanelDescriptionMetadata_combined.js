...
var WebExpansionPanelDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebExpansionPanelDescriptionMetadata, _super);
    ...
    WebExpansionPanelDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebExpansionPanelDescriptionMetadata.a)) {
            return;
        }
        a.y(WebExpansionPanelDescriptionMetadata.a);
    ...
    WebExpansionPanelDescriptionMetadata.c = function (a) {
        ...
        a.item("__tagNameWC", "String:igc-expansion-panel");
        a.item("Open", "Boolean");
    ...
    WebExpansionPanelDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebExpansionPanel", function () { return new WebExpansionPanelDescription(); });
        a.z("WebExpansionPanel", WebExpansionPanelDescriptionMetadata.a);
    };
...
var WebExpansionPanelComponentEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebExpansionPanelComponentEventArgsDescriptionMetadata, _super);
    ...
    WebExpansionPanelComponentEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebExpansionPanelComponentEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(WebExpansionPanelComponentEventArgsDescriptionMetadata.a);
    ...
    WebExpansionPanelComponentEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebExpansionPanelComponentEventArgs", function () { return new WebExpansionPanelComponentEventArgsDescription(); });
        a.z("WebExpansionPanelComponentEventArgs", WebExpansionPanelComponentEventArgsDescriptionMetadata.a);
    };
