...
var GridBridge = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(GridBridge, _super);
    function GridBridge() {
        var _this = _super.call(this) || this;
        _this.i = new List$1(GridBridgeColumnDefinition.$, 0);
        _this.j = new List$1(GridBridgeRowDefinition.$, 0);
        return _this;
    }
    ...
    GridBridge.prototype.k = function (a) {
        var b = "";
        for (var c = 0; c < this.i.count; c++) {
            if (c > 0) {
                b += " ";
            }
            b += this.i._inner[c].c();
    ...
    GridBridge.prototype.l = function (a) {
        var b = "";
        for (var c = 0; c < this.j.count; c++) {
            if (c > 0) {
                b += " ";
            }
            b += this.j._inner[c].c();
    ...
    GridBridge.prototype.getColumn = function (a, b) {
        var c = b.v.getStyleProperty("grid-column");
        var d = parseInt(c);
        return d - 1;
    };
    ...
    GridBridge.prototype.getRow = function (a, b) {
        var c = b.v.getStyleProperty("grid-row");
        var d = parseInt(c);
        return d - 1;
    };
