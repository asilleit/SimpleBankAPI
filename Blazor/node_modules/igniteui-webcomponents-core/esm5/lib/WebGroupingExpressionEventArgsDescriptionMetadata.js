 ...
 * @hidden
 */
var WebGroupingExpressionEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebGroupingExpressionEventArgsDescriptionMetadata, _super);
    function WebGroupingExpressionEventArgsDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WebGroupingExpressionEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebGroupingExpressionEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(WebGroupingExpressionEventArgsDescriptionMetadata.a);
        WebGroupingExpressionDescriptionMetadata.d(a);
    };
    WebGroupingExpressionEventArgsDescriptionMetadata.c = function (a) {
    ...
    WebGroupingExpressionEventArgsDescriptionMetadata.d = function (a) {
        WebGroupingExpressionEventArgsDescriptionMetadata.b(a);
        a.aa("WebGroupingExpressionEventArgs", function () { return new WebGroupingExpressionEventArgsDescription(); });
        a.z("WebGroupingExpressionEventArgs", WebGroupingExpressionEventArgsDescriptionMetadata.a);
    };
...
export { WebGroupingExpressionEventArgsDescriptionMetadata };
