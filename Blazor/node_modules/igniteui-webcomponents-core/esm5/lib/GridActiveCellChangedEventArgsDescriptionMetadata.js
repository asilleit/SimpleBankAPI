...
var GridActiveCellChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridActiveCellChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridActiveCellChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridActiveCellChangedEventArgsDescriptionMetadata.a);
    ...
    GridActiveCellChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridActiveCellChangedEventArgs", function () { return new GridActiveCellChangedEventArgsDescription(); });
        a.z("GridActiveCellChangedEventArgs", GridActiveCellChangedEventArgsDescriptionMetadata.a);
    };
