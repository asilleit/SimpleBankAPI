...
var TypicalPriceIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TypicalPriceIndicatorDescriptionMetadata.b = function (a) {
        if (TypicalPriceIndicatorDescriptionMetadata.a == null) {
            ...
            TypicalPriceIndicatorDescriptionMetadata.c(TypicalPriceIndicatorDescriptionMetadata.a);
        }
        if (a.j(TypicalPriceIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(TypicalPriceIndicatorDescriptionMetadata.a);
    };
    TypicalPriceIndicatorDescriptionMetadata.c = function (a) {
    ...
    TypicalPriceIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("TypicalPriceIndicator", function () { return new TypicalPriceIndicatorDescription(); });
        a.z("TypicalPriceIndicator", TypicalPriceIndicatorDescriptionMetadata.a);
    };
