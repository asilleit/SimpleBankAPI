...
var WebIconButtonDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebIconButtonDescriptionMetadata, _super);
    ...
    WebIconButtonDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebIconButtonDescriptionMetadata.a)) {
            return;
        }
        a.y(WebIconButtonDescriptionMetadata.a);
    };
    WebIconButtonDescriptionMetadata.c = function (a) {
        ...
        a.item("Variant@names", "Flat;Contained;Outlined");
    };
    WebIconButtonDescriptionMetadata.d = function (a) {
        WebIconButtonDescriptionMetadata.b(a);
        a.aa("WebIconButton", function () { return new WebIconButtonDescription(); });
        a.z("WebIconButton", WebIconButtonDescriptionMetadata.a);
    };
