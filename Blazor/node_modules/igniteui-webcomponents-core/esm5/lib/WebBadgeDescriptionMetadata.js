...
var WebBadgeDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebBadgeDescriptionMetadata, _super);
    ...
    WebBadgeDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebBadgeDescriptionMetadata.a)) {
            return;
        }
        a.y(WebBadgeDescriptionMetadata.a);
    };
    ...
    WebBadgeDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebBadge", function () { return new WebBadgeDescription(); });
        a.z("WebBadge", WebBadgeDescriptionMetadata.a);
    };
