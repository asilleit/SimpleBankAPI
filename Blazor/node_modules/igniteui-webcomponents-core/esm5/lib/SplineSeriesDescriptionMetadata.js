...
var SplineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineSeriesDescriptionMetadata.b = function (a) {
        if (SplineSeriesDescriptionMetadata.a == null) {
            ...
            SplineSeriesDescriptionMetadata.c(SplineSeriesDescriptionMetadata.a);
        }
        if (a.j(SplineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(SplineSeriesDescriptionMetadata.a);
    };
    SplineSeriesDescriptionMetadata.c = function (a) {
        SplineSeriesBaseDescriptionMetadata.c(a);
    };
    SplineSeriesDescriptionMetadata.d = function (a) {
        SplineSeriesDescriptionMetadata.b(a);
        a.aa("SplineSeries", function () { return new SplineSeriesDescription(); });
        a.z("SplineSeries", SplineSeriesDescriptionMetadata.a);
    };
