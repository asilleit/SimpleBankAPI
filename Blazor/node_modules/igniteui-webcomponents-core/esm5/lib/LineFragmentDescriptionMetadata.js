...
var LineFragmentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LineFragmentDescriptionMetadata.b = function (a) {
        ...
        if (a.j(LineFragmentDescriptionMetadata.a)) {
            return;
        }
        a.y(LineFragmentDescriptionMetadata.a);
    };
    ...
    LineFragmentDescriptionMetadata.d = function (a) {
        ...
        a.aa("LineFragment", function () { return new LineFragmentDescription(); });
        a.z("LineFragment", LineFragmentDescriptionMetadata.a);
    };
