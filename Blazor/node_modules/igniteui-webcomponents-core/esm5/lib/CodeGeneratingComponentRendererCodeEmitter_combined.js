...
var CodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGeneratingComponentRendererCodeEmitter, _super);
    function CodeGeneratingComponentRendererCodeEmitter(a, b) {
        var _this = _super.call(this) || this;
        _this.l = null;
        _this.j = null;
        _this.y = new List$1(CodeGenerationItemBuilderPropertyInfo.$, 0);
        _this.d = null;
        _this.a = null;
        _this.c = null;
        _this.b = null;
        _this.z = new List$1(String_$type, 0);
        _this.ac = new Stack$1(String_$type);
        _this.aa = new Stack$1(String_$type);
        _this.ab = new Stack$1(Boolean_$type);
        _this.ay = null;
        _this.ax = null;
        _this.l = a;
        _this.j = b;
        _this.d = new CodeGeneratingCodeWriter(_this.l);
        _this.a = new CodeGeneratingCodeWriter(_this.l);
        _this.c = new CodeGeneratingCodeWriter(_this.l);
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.v = function (a, b) {
        ...
        if (a.hasMustSetInCodePlatforms(b.b.owningType, b.b.propertyName)) {
            var c = a.getMustSetInCodePlatforms(b.b.owningType, b.b.propertyName);
            var _loop_1 = function (e) {
                var d = c[e];
                var f;
                if (((function () { var g = EnumUtil.tryParse$1(CodeGenerationTargetPlatforms_$type, d, true, f); f = g.p2; return g.ret; })())) {
                    if (f == this_1.j.platform) {
                        return { value: true };
                    }
                }
            };
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.q = function (a, b) {
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.t = function (a) {
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
    CodeGeneratingComponentRendererCodeEmitter.prototype.aw = function (a, b, c) {
        if (b.b == null) {
            return b.c;
        }
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.ap = function (a) {
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.get_w = function () {
        return false;
    };
    Object.defineProperty(CodeGeneratingComponentRendererCodeEmitter.prototype, "w", {
        get: function () {
            return this.get_w();
        },
        enumerable: true,
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.an = function (a) {
        ...
        b = CodeGeneratingComponentRenderer.d1(b);
        return this.j.v(b);
    };
    ...
    Object.defineProperty(CodeGeneratingComponentRendererCodeEmitter.prototype, "u", {
        get: function () {
            return this.ac.f == 1;
        },
        enumerable: true,
    ...
    CodeGeneratingComponentRendererCodeEmitter.prototype.get_n = function () {
        return this.r;
    };
    Object.defineProperty(CodeGeneratingComponentRendererCodeEmitter.prototype, "n", {
        get: function () {
            return this.get_n();
        },
        enumerable: true,
...
var BlazorRazorCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(BlazorRazorCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.al = function (a, b, c, d) {
        ...
        this.f.l("private " + b.m() + " _" + CodeGeneratingComponentRenderer.d1(d) + " = null;");
        this.f.l("public " + b.m() + " " + CodeGeneratingComponentRenderer.d2(d));
        this.f.l("{");
        this.f.h();
        this.f.l("get");
        this.f.l("{");
        this.f.h();
        this.f.l("if (this._" + CodeGeneratingComponentRenderer.d1(d) + " == null)");
        this.f.l("{");
        this.f.h();
        this.f.k(c);
        this.f.l("this._" + CodeGeneratingComponentRenderer.d1(d) + " = " + d + ";");
        this.f.f();
        this.f.l("}");
        this.f.l("return this._" + CodeGeneratingComponentRenderer.d1(d) + ";");
        this.f.f();
        this.f.l("}");
        this.f.f();
        this.f.l("}");
        return CodeGeneratingComponentRenderer.d2(d);
    };
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.bl = function (a, b, c) {
        if (c.c == null) {
            return "null";
        }
        var d = c.c;
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.a3 = function (a) {
        ...
        if (!this.bi.contains(this.aj)) {
            ...
            this.f.l("private " + this.ak + " " + CodeGeneratingComponentRenderer.d1(this.aj) + ";");
            if (!this.p) {
                if (this.u) {
                    this.g.l("var " + CodeGeneratingComponentRenderer.d1(this.aj) + " = this." + CodeGeneratingComponentRenderer.d1(this.aj) + ";");
                }
            }
            else {
                this.g.l("var " + CodeGeneratingComponentRenderer.d1(this.aj) + " = this." + CodeGeneratingComponentRenderer.d1(this.aj) + ";");
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.a9 = function (a, b, c, d) {
        if (c.b != null && d.hasNameBinding(c.b.owningType, CodeGeneratingComponentRenderer.d2(c.b.propertyName)) && this.q(d, c)) {
            this.bh(c);
            if (a > 0) {
                this.h.l("");
            }
        ...
        if (this.s(c)) {
            ...
            var e = CodeGeneratingComponentRenderer.d1(this.aw(d, c, true));
            var f = e;
            if (f != "null" && !stringStartsWith(f, "this.")) {
                f = "this." + f;
            }
            this.e.l(CodeGeneratingComponentRenderer.d1(this.aj) + "." + b + " = " + f + ";");
            return;
        }
        if (a > 0) {
            this.h.l("");
        ...
        if (b == "Name") {
            this.h.l("");
            this.h.j("@ref=\"" + CodeGeneratingComponentRenderer.d1(this.aw(d, c, true)) + "\"");
        }
    };
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.aw = function (a, b, c) {
        if (b.b == null) {
            return b.c;
        }
        if (typeCast(CodeGenerationSpecialValue.$, b.c) !== null) {
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.ad = function (a) {
        var b = a.c;
        switch (b.a) {
            case 3: return b.b;
            case 0: return b.b;
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "@null";
    };
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.ao = function (a) {
        return CodeGeneratingComponentRenderer.d1(CodeGeneratingComponentRenderer.d1(a.a.e));
    };
    ...
    BlazorRazorCodeGeneratingComponentRendererCodeEmitter.prototype.ba = function (a, b, c, d) {
        ...
        if (c.b.knownType == 9) {
            ...
            if (e != null) {
                try {
                    for (var _b = tslib_1.__values(fromEn(e)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var f = _c.value;
...
var BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.am = function (a, b) {
        if (b.b.specificExternalType == "string") {
            return this.bl(b.b.specificExternalType, b);
        }
        if (b.c == null) {
            return "null";
        }
    ...
    BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.ap = function (a) {
        var b = a.b != null ? a.b.specificType + "." : "";
        return b + (a.c != null ? a.c.toString() : "");
    };
    BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.aw = function (a, b, c) {
        if (b.b == null) {
            return "\"" + b.c + "\"";
        }
        if (typeCast(CodeGenerationSpecialValue.$, b.c) !== null) {
        ...
        switch (b.b.knownType) {
            ...
            case 6:
            case 16:
            case 2: return "\"" + _super.prototype.aw.call(this, a, b, c) + "\"";
            case 9: throw new NotSupportedException(1, "shouldn't get here");
        }
        return _super.prototype.aw.call(this, a, b, c);
    };
    BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.ad = function (a) {
        var b = a.c;
        switch (b.a) {
            case 3: return b.b;
            case 0: return b.b;
    ...
    BlazorCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
...
var ReactMarkupCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ReactMarkupCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.al = function (a, b, c, d) {
        d = _super.prototype.al.call(this, a, b, c, d);
        var e = b.p();
        this.f.l("private " + " _" + CodeGeneratingComponentRenderer.d1(d) + ": " + e + " | null = null;");
        this.f.l("public get " + CodeGeneratingComponentRenderer.d1(d) + "(): " + e + " {");
        this.f.h();
        this.f.l("if (this._" + CodeGeneratingComponentRenderer.d1(d) + " == null)");
        this.f.l("{");
        this.f.h();
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.a3 = function (a) {
        ...
        if (!this.bi.contains(this.aj)) {
            this.bi.add_1(this.aj);
            this.f.l("private " + CodeGeneratingComponentRenderer.d1(this.aj) + ": " + this.ak);
            if (this.u) {
                this.f.l("private " + CodeGeneratingComponentRenderer.d1(this.aj) + "Ref(r: " + this.ak + ") {");
                this.f.h();
                this.f.l("this." + CodeGeneratingComponentRenderer.d1(this.aj) + " = r;");
                this.f.l("this.setState({});");
                this.f.f();
                this.f.l("}");
                this.g.l("this." + CodeGeneratingComponentRenderer.d1(this.aj) + "Ref = " + "this." + CodeGeneratingComponentRenderer.d1(this.aj) + "Ref.bind(this);");
            }
        }
    };
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.bk = function () {
        var a = CodeGeneratingComponentRenderer.d1(stringReplace(stringReplace(this.ak, this.az, ""), "Component", ""));
        a = this.k.u(a);
        return a;
    };
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.aq = function (a) {
        if (!stringIsNullOrEmpty(a.a.e)) {
            ...
            if (!this.bi.contains(a.a.e)) {
                this.g.l("this." + CodeGeneratingComponentRenderer.d1(a.a.e) + " = " + "this." + CodeGeneratingComponentRenderer.d1(a.a.e) + ".bind(this);");
            }
            return "this." + CodeGeneratingComponentRenderer.d1(a.a.e);
        }
        return this.at();
    };
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.a9 = function (a, b, c, d) {
        var e = CodeGeneratingComponentRenderer.d1(b);
        ...
        if (e == "name") {
            if (this.u) {
                ...
                this.h.j("ref={this." + CodeGeneratingComponentRenderer.d1(this.aw(d, c, true)) + "Ref}");
            }
        }
    };
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
 ...
 * @hidden
 */
var WebCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.a3 = function (a) {
        ...
        if (!this.bi.contains(this.aj)) {
            ...
            if (!this.p) {
                if (this.u) {
                    this.g.l("var " + CodeGeneratingComponentRenderer.d1(this.aj) + " = this." + CodeGeneratingComponentRenderer.d1(this.aj) + " = document.querySelector('" + CodeGeneratingComponentRenderer.d3(stringReplace(this.ak, "Component", "")) + "') as " + this.ak + ";");
                }
            }
            else {
                this.g.l("var " + CodeGeneratingComponentRenderer.d1(this.aj) + " = this." + CodeGeneratingComponentRenderer.d1(this.aj) + " = document.getElementById('" + this.aj + "') as " + this.ak + ";");
            }
        }
    };
    ...
    WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.a9 = function (a, b, c, d) {
        ...
        if (this.q(d, c)) {
            ...
            var f = CodeGeneratingComponentRenderer.d1(this.aw(d, c, true));
            var g = f;
            if (g != "null" && !stringStartsWith(g, "this.")) {
                g = "this." + g;
            }
            if (this.ak == "any" && stringContains(e, "-")) {
                this.e.l(CodeGeneratingComponentRenderer.d1(this.aj) + "['" + e + "'] = " + g);
            }
            else {
                this.e.l(CodeGeneratingComponentRenderer.d1(this.aj) + "." + e + " = " + g);
            }
        ...
        if (this.ak == "any" && stringContains(e, "-")) {
            this.h.j(this.aj + "." + CodeGeneratingComponentRenderer.d1(this.aj) + "['" + e + "']");
        }
        else {
            this.h.j(this.aj + "." + CodeGeneratingComponentRenderer.d1(e));
        }
        this.h.j(" = ");
        this.h.j(this.aw(d, c, true));
    };
    ...
    WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
    ...
    WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.aw = function (a, b, c) {
        if (b.b == null) {
            return "\"" + b.c + "\"";
        }
        if (typeCast(CodeGenerationSpecialValue.$, b.c) !== null) {
    ...
    WebCodeBehindCodeGeneratingComponentRendererCodeEmitter.$t = markType(WebCodeBehindCodeGeneratingComponentRendererCodeEmitter, 'WebCodeBehindCodeGeneratingComponentRendererCodeEmitter', CodeGeneratingComponentRendererCodeEmitter.$);
    return WebCodeBehindCodeGeneratingComponentRendererCodeEmitter;
}(CodeGeneratingComponentRendererCodeEmitter));
export { WebCodeBehindCodeGeneratingComponentRendererCodeEmitter };
/**
 * @hidden
 */
var ReactCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ReactCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
    function ReactCodeBehindCodeGeneratingComponentRendererCodeEmitter(a, b) {
        return _super.call(this, a, b) || this;
    }
    ReactCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.get_r = function () {
        return true;
    };
...
}(WebCodeBehindCodeGeneratingComponentRendererCodeEmitter));
...
var WebComponentsMarkupCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebComponentsMarkupCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(WebComponentsMarkupCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    WebComponentsMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.a9 = function (a, b, c, d) {
        ...
        this.h.j(CodeGeneratingComponentRenderer.d3(e));
        this.h.j("=");
        this.h.j("\"");
        this.h.j(this.aw(d, c, true));
        this.h.j("\"");
    ...
    WebComponentsMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
...
var WebComponentsCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebComponentsCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
...
var TSCodeGeneratingComponentRendererHandlerEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(TSCodeGeneratingComponentRendererHandlerEmitter.prototype, "w", {
        get: function () {
            switch (this.u) {
                case 1: return "Igx";
                case 2: return "Igr";
    ...
    TSCodeGeneratingComponentRendererHandlerEmitter.prototype.t = function (a, b) {
        ...
        c.execute(b, function (d, e, f) {
            var g = d(1);
            var h = d(2);
            h = stringReplace(h, "webcomponents", _this.v);
            h = stringReplace(h, "react", _this.v);
            h = stringReplace(h, "angular", _this.v);
            var i = g.split(',');
            for (var k = 0; k < i.length; k++) {
                var j = i[k];
                var l = j.trim();
                if (stringStartsWith(l, "Igc")) {
                    l = _this.w + l.substr(3);
                }
    ...
    TSCodeGeneratingComponentRendererHandlerEmitter.prototype.o = function (a) {
        return a;
    };
...
var TSCodeGeneratingComponentRendererDataEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(TSCodeGeneratingComponentRendererDataEmitter, _super);
    ...
    TSCodeGeneratingComponentRendererDataEmitter.prototype.v = function (a, b) {
        ...
        a = CodeGeneratingComponentRenderer.d2(a);
        a = stringReplace(a, "-", "_");
        if (b) {
            a += "Item";
        }
    ...
    TSCodeGeneratingComponentRendererDataEmitter.prototype.ao = function (a) {
        a = stringReplace(a, "-", "_");
        return "_" + CodeGeneratingComponentRenderer.d1(a);
    };
    ...
    TSCodeGeneratingComponentRendererDataEmitter.prototype.ab = function (a, b, c) {
        ...
        b.l("export class " + a.d + " {");
        b.h();
        b.l("public constructor(init: Partial<" + a.d + ">) {");
        b.h();
        b.l("Object.assign(this, init);");
        b.f();
        b.l("}");
        b.l("");
...
var AngularTemplateCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(AngularTemplateCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(AngularTemplateCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    AngularTemplateCodeGeneratingComponentRendererCodeEmitter.prototype.a3 = function (a) {
        ...
        if (!this.bi.contains(this.aj)) {
            ...
            this.f.l("@ViewChild(\"" + CodeGeneratingComponentRenderer.d1(this.aj) + "\", { static: true } )");
            this.f.l("private " + CodeGeneratingComponentRenderer.d1(this.aj) + ": " + this.ak);
        }
    };
    ...
    AngularTemplateCodeGeneratingComponentRendererCodeEmitter.prototype.a9 = function (a, b, c, d) {
        ...
        if (e == "name") {
            this.h.l("");
            this.h.j("#" + CodeGeneratingComponentRenderer.d1(this.aw(d, c, true)));
        }
    };
    AngularTemplateCodeGeneratingComponentRendererCodeEmitter.prototype.aq = function (a) {
        if (!stringIsNullOrEmpty(a.a.e)) {
            this.bh(a);
            return "this." + CodeGeneratingComponentRenderer.d1(a.a.e) + "($event)";
        }
        return this.at();
    };
    ...
    AngularTemplateCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "null";
    };
...
var AngularCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(AngularCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
    function AngularCodeBehindCodeGeneratingComponentRendererCodeEmitter(a, b) {
        return _super.call(this, a, b) || this;
    }
    AngularCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.get_r = function () {
        return true;
    };
...
var DotNetCodeGeneratingComponentRendererDataEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(DotNetCodeGeneratingComponentRendererDataEmitter, _super);
...
var WPFXamlCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WPFXamlCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(WPFXamlCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    WPFXamlCodeGeneratingComponentRendererCodeEmitter.prototype.at = function () {
        return "{x:Null}";
    };
...
var WPFCodeBehindCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WPFCodeBehindCodeGeneratingComponentRendererCodeEmitter, _super);
    ...
    Object.defineProperty(WPFCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype, "r", {
        get: function () {
            return this.get_r();
        },
        enumerable: true,
    ...
    WPFCodeBehindCodeGeneratingComponentRendererCodeEmitter.prototype.get_x = function () {
        return false;
    };
...
var CodeGeneratingComponentRenderer = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGeneratingComponentRenderer, _super);
    function CodeGeneratingComponentRenderer(a, b) {
        ...
        _this.dt = b;
        _this.du = a;
        ComponentRenderer.platform = CodeGeneratingComponentRenderer.d0(a);
    ...
    CodeGeneratingComponentRenderer.prototype.dm = function (a, b, c) {
        switch (this.du) {
    ...
    CodeGeneratingComponentRenderer.prototype.dp = function (a, b) {
        switch (this.du) {
            case 1: return new TSCodeGeneratingComponentRendererHandlerEmitter(a, b, this.du);
            case 2: return new TSCodeGeneratingComponentRendererHandlerEmitter(a, b, this.du);
            case 3: return new TSCodeGeneratingComponentRendererHandlerEmitter(a, b, this.du);
            case 4: break;
            case 0:
    ...
    CodeGeneratingComponentRenderer.prototype.dr = function (a, b) {
        switch (this.du) {
            case 1: return new TSCodeGeneratingComponentRendererTemplateEmitter(a, b, this.du);
            case 2: return new TSCodeGeneratingComponentRendererTemplateEmitter(a, b, this.du);
            case 3: return new TSCodeGeneratingComponentRendererTemplateEmitter(a, b, this.du);
            case 4: break;
            case 0:
    ...
    CodeGeneratingComponentRenderer.prototype.dq = function (a, b) {
        switch (this.du) {
            case 1: return new TSCodeGeneratingComponentRendererModuleEmitter(this.du, a, b);
            case 2: return new TSCodeGeneratingComponentRendererModuleEmitter(this.du, a, b);
            case 3: return new TSCodeGeneratingComponentRendererModuleEmitter(this.du, a, b);
            case 4: break;
            case 0: return new DotNetCodeGeneratingComponentRendererModuleEmitter(this.du, a, b);
            case 5: return new BlazorCodeGeneratingComponentRendererModuleEmitter(this.du, a, b);
        }
        return null;
    };
    CodeGeneratingComponentRenderer.prototype.emitCode = function (a) {
        ...
        b.platform = this.du;
        b.generationOptions = this.dt;
        try {
            for (var _d = tslib_1.__values(fromEnum(this.a5.keys)), _e = _d.next(); !_e.done; _e = _d.next()) {
                var c = _e.value;
                var d = c;
                var e = d.id;
                try {
                    for (var _f = (e_17 = void 0, tslib_1.__values(fromEnum(d.a))), _g = _f.next(); !_g.done; _g = _f.next()) {
                        var f = _g.value;
                        if (f.i("Name") != null) {
        ...
        try {
            for (var _h = tslib_1.__values(fromEnum(this.a5.keys)), _j = _h.next(); !_j.done; _j = _h.next()) {
                var g = _j.value;
                var h = g;
                h.c(b, this, this.dt);
            }
        ...
        if (this.dx != null) {
            var i = this.dq(this.dt, b);
            i.n(this.dx, this.context);
        }
        if (this.dz != null) {
            if (typeCast(JsonDictionaryObject.$, this.dz) !== null) {
                var j = this.dz;
                var m = j.e();
        ...
        {
            var n = this.dn(this.dt, b);
            n.aa(this.dy);
        }
        var o = this.dp(this.dt, b);
        ...
        var ab = this.dr(this.dt, b);
        ab.p();
        this.d7(b, a);
        return b;
    };
    CodeGeneratingComponentRenderer.prototype.d7 = function (a, b) {
        b.execute(a);
    };
    CodeGeneratingComponentRenderer.prototype.ba = function () {
        return runOn(this, this.d5);
    };
    CodeGeneratingComponentRenderer.prototype.d4 = function (a) {
        ...
        switch (this.du) {
            case 1:
            case 2:
            case 3: return CodeGeneratingComponentRenderer.d1(a);
            case 4:
            case 0:
            case 5: return CodeGeneratingComponentRenderer.d2(a);
        }
        return a;
    };
...
var CodeGenerationContainer = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGenerationContainer, _super);
...
var CodeGenerationItemBuilder = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGenerationItemBuilder, _super);
    ...
    CodeGenerationItemBuilder.prototype.a = function (a) {
        ...
        return new CodeGenerationItemBuilder(this.b, this.q(b), this.c, this.h);
    };
    CodeGenerationItemBuilder.prototype.q = function (a) {
        return a.specificExternalType != null ? a.specificExternalType : a.specificType;
    };
    CodeGenerationItemBuilder.prototype.v = function (a, b, c, d) {
    ...
    CodeGenerationItemBuilder.prototype.t = function (a, b, c) {
        var d = null;
        if (!this.f.containsKey(a)) {
            this.g.add(a);
        }
    ...
    CodeGenerationItemBuilder.prototype.u = function (a, b) {
        if (this.f.containsKey(a)) {
            this.f.removeItem(a);
        }
    };
    ...
    CodeGenerationItemBuilder.prototype.s = function (a, b) {
        ...
        var j = 0;
        try {
            for (var _e = tslib_1.__values(fromEnum(this.g)), _f = _e.next(); !_f.done; _f = _e.next()) {
                var k = _f.value;
                var l = this.f.item(k);
    ...
    CodeGenerationItemBuilder.prototype.d = function (a, b, c) {
        if (c.b == null) {
            if (b.toLowerCase() == "name") {
                return true;
            }
        }
        switch (c.b.knownType) {
            case 10:
            case 7: return true;
            case 4: return c.c == null || !(typeCast(LinearGradientBrush.$, c.c) !== null);
            case 6:
                return true;
                break;
            case 9:
    ...
    CodeGenerationItemBuilder.prototype.p = function () {
        if (this.b == 1 || this.b == 3 || this.b == 2) {
            if (this.c.getMetadata(this.j, "__isPlainObject") != null) {
                return "any";
            }
        }
        return this.m();
    ...
    CodeGenerationItemBuilder.prototype.m = function () {
        ...
        else if ((this.b == 5 || this.b == 2 || this.b == 1 || this.b == 3) && this.c.getMetadata(this.j, "__qualifiedNameTS") != null) {
            var d = this.c.getMetadata(this.j, "__qualifiedNameTS");
            return this.k + d.specificExternalType + this.l;
        }
        else {
            return this.k + this.j + this.l;
        }
    };
    CodeGenerationItemBuilder.prototype.o = function () {
        var a = this.c.getMetadata(this.j, "_qualifiedName");
        if (a != null) {
            var b = a.specificExternalType;
            var c = b.split('.');
...
var CodeGenerationRendererAdapter = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(CodeGenerationRendererAdapter, _super);
