...
var StackedAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(StackedAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(StackedAreaSeriesDescriptionMetadata.a);
    };
    ...
    StackedAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("StackedAreaSeries", function () { return new StackedAreaSeriesDescription(); });
        a.z("StackedAreaSeries", StackedAreaSeriesDescriptionMetadata.a);
    };
