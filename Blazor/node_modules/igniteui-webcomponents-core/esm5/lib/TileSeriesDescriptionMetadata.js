...
var TileSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TileSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TileSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(TileSeriesDescriptionMetadata.a);
    ...
    TileSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("TileSeries", function () { return new TileSeriesDescription(); });
        a.z("TileSeries", TileSeriesDescriptionMetadata.a);
    };
