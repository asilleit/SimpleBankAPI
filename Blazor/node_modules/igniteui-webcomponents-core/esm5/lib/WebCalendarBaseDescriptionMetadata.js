...
var WebCalendarBaseDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebCalendarBaseDescriptionMetadata, _super);
    ...
    WebCalendarBaseDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebCalendarBaseDescriptionMetadata.a)) {
            return;
        }
        a.y(WebCalendarBaseDescriptionMetadata.a);
    ...
    WebCalendarBaseDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebCalendarBase", function () { return new WebCalendarBaseDescription(); });
        a.z("WebCalendarBase", WebCalendarBaseDescriptionMetadata.a);
    };
