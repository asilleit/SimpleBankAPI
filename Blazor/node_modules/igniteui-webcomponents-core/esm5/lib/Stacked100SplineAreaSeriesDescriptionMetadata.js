...
var Stacked100SplineAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Stacked100SplineAreaSeriesDescriptionMetadata.b = function (a) {
        if (Stacked100SplineAreaSeriesDescriptionMetadata.a == null) {
            ...
            Stacked100SplineAreaSeriesDescriptionMetadata.c(Stacked100SplineAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(Stacked100SplineAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(Stacked100SplineAreaSeriesDescriptionMetadata.a);
    };
    Stacked100SplineAreaSeriesDescriptionMetadata.c = function (a) {
        StackedSplineAreaSeriesDescriptionMetadata.c(a);
    };
    Stacked100SplineAreaSeriesDescriptionMetadata.d = function (a) {
        Stacked100SplineAreaSeriesDescriptionMetadata.b(a);
        a.aa("Stacked100SplineAreaSeries", function () { return new Stacked100SplineAreaSeriesDescription(); });
        a.z("Stacked100SplineAreaSeries", Stacked100SplineAreaSeriesDescriptionMetadata.a);
    };
