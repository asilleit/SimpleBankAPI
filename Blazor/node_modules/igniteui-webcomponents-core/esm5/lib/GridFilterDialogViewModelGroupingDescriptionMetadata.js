...
var GridFilterDialogViewModelGroupingDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogViewModelGroupingDescriptionMetadata.b = function (a) {
        if (GridFilterDialogViewModelGroupingDescriptionMetadata.a == null) {
            ...
            GridFilterDialogViewModelGroupingDescriptionMetadata.c(GridFilterDialogViewModelGroupingDescriptionMetadata.a);
        }
        if (a.j(GridFilterDialogViewModelGroupingDescriptionMetadata.a)) {
            return;
        }
        a.y(GridFilterDialogViewModelGroupingDescriptionMetadata.a);
    };
    GridFilterDialogViewModelGroupingDescriptionMetadata.c = function (a) {
        a.item("StartIndex", "Number:int");
        a.item("EndIndex", "Number:int");
        a.item("IsOrGrouping", "Boolean");
    };
    GridFilterDialogViewModelGroupingDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridFilterDialogViewModelGrouping", function () { return new GridFilterDialogViewModelGroupingDescription(); });
        a.z("GridFilterDialogViewModelGrouping", GridFilterDialogViewModelGroupingDescriptionMetadata.a);
    };
