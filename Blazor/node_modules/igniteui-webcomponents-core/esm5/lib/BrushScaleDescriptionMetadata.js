...
var BrushScaleDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BrushScaleDescriptionMetadata.b = function (a) {
        ...
        if (a.j(BrushScaleDescriptionMetadata.a)) {
            return;
        }
        a.y(BrushScaleDescriptionMetadata.a);
    ...
    BrushScaleDescriptionMetadata.d = function (a) {
        ...
        a.aa("BrushScale", function () { return new BrushScaleDescription(); });
        a.z("BrushScale", BrushScaleDescriptionMetadata.a);
    };
