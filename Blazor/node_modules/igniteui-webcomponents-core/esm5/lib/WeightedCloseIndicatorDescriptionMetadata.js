...
var WeightedCloseIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WeightedCloseIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WeightedCloseIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(WeightedCloseIndicatorDescriptionMetadata.a);
    };
    ...
    WeightedCloseIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("WeightedCloseIndicator", function () { return new WeightedCloseIndicatorDescription(); });
        a.z("WeightedCloseIndicator", WeightedCloseIndicatorDescriptionMetadata.a);
    };
