...
var DataSourcePropertiesComparer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataSourcePropertiesComparer(a, b, c, d) {
        ...
        if (a != null) {
            ...
            for (var g = 0; g < a.length; g++) {
                ...
                for (var k = 0; k < j.length; k++) {
                    ...
                    var m = false;
                    if (h != null) {
                        for (var n = 0; n < h.propertyNames.length; n++) {
                            if (l == h.propertyNames[n]) {
                                m = true;
                                if (h.subSchemas != null && h.subSchemas.length > n) {
                                    h = h.subSchemas[n];
                                }
                                else {
                                    h = null;
        ...
        var o = new Dictionary$2(String_$type, DataSourceSchemaPropertyType_$type, 0);
        for (var p = 0; p < _this.f.propertyNames.length; p++) {
            o.item(_this.f.propertyNames[p], _this.f.propertyTypes[p]);
        }
        if (_this.b != null) {
            for (var q = 0; q < _this.b.length; q++) {
                if (o.containsKey(_this.b[q])) {
                    _this.d[q] = o.item(_this.b[q]);
                }
                else {
                    _this.d[q] = d.resolveSchemaPropertyType(_this.b[q]);
                }
            }
        }
        return _this;
