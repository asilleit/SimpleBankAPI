...
var ScatterLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ScatterLineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ScatterLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(ScatterLineSeriesDescriptionMetadata.a);
    };
    ScatterLineSeriesDescriptionMetadata.c = function (a) {
    ...
    ScatterLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("ScatterLineSeries", function () { return new ScatterLineSeriesDescription(); });
        a.z("ScatterLineSeries", ScatterLineSeriesDescriptionMetadata.a);
    };
