...
var DataBindingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataBindingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(DataBindingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(DataBindingEventArgsDescriptionMetadata.a);
    };
    DataBindingEventArgsDescriptionMetadata.c = function (a) {
    ...
    DataBindingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("DataBindingEventArgs", function () { return new DataBindingEventArgsDescription(); });
        a.z("DataBindingEventArgs", DataBindingEventArgsDescriptionMetadata.a);
    };
