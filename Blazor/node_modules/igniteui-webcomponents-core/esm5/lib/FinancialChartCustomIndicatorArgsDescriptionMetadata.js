...
var FinancialChartCustomIndicatorArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FinancialChartCustomIndicatorArgsDescriptionMetadata.b = function (a) {
        if (FinancialChartCustomIndicatorArgsDescriptionMetadata.a == null) {
            ...
            FinancialChartCustomIndicatorArgsDescriptionMetadata.c(FinancialChartCustomIndicatorArgsDescriptionMetadata.a);
        }
        if (a.j(FinancialChartCustomIndicatorArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(FinancialChartCustomIndicatorArgsDescriptionMetadata.a);
        SeriesDescriptionMetadata.d(a);
    };
    FinancialChartCustomIndicatorArgsDescriptionMetadata.c = function (a) {
    ...
    FinancialChartCustomIndicatorArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("FinancialChartCustomIndicatorArgs", function () { return new FinancialChartCustomIndicatorArgsDescription(); });
        a.z("FinancialChartCustomIndicatorArgs", FinancialChartCustomIndicatorArgsDescriptionMetadata.a);
    };
