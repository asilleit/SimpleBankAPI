...
var LinearContourValueResolverDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LinearContourValueResolverDescriptionMetadata.b = function (a) {
        ...
        if (a.j(LinearContourValueResolverDescriptionMetadata.a)) {
            return;
        }
        a.y(LinearContourValueResolverDescriptionMetadata.a);
    };
    ...
    LinearContourValueResolverDescriptionMetadata.d = function (a) {
        ...
        a.aa("LinearContourValueResolver", function () { return new LinearContourValueResolverDescription(); });
        a.z("LinearContourValueResolver", LinearContourValueResolverDescriptionMetadata.a);
    };
