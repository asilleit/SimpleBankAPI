...
var CalloutLabelUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutLabelUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CalloutLabelUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(CalloutLabelUpdatingEventArgsDescriptionMetadata.a);
    ...
    CalloutLabelUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("CalloutLabelUpdatingEventArgs", function () { return new CalloutLabelUpdatingEventArgsDescription(); });
        a.z("CalloutLabelUpdatingEventArgs", CalloutLabelUpdatingEventArgsDescriptionMetadata.a);
    };
