...
var SliceClickEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SliceClickEventArgsDescriptionMetadata.b = function (a) {
        if (SliceClickEventArgsDescriptionMetadata.a == null) {
            ...
            SliceClickEventArgsDescriptionMetadata.c(SliceClickEventArgsDescriptionMetadata.a);
        }
        if (a.j(SliceClickEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(SliceClickEventArgsDescriptionMetadata.a);
    };
    SliceClickEventArgsDescriptionMetadata.c = function (a) {
    ...
    SliceClickEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("SliceClickEventArgs", function () { return new SliceClickEventArgsDescription(); });
        a.z("SliceClickEventArgs", SliceClickEventArgsDescriptionMetadata.a);
    };
