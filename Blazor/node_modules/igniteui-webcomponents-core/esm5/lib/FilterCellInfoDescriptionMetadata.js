...
var FilterCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(FilterCellInfoDescriptionMetadata, _super);
    ...
    FilterCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.j(FilterCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.y(FilterCellInfoDescriptionMetadata.a);
    ...
    FilterCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.aa("FilterCellInfo", function () { return new FilterCellInfoDescription(); });
        a.z("FilterCellInfo", FilterCellInfoDescriptionMetadata.a);
    };
