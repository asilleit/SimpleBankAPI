...
var AverageTrueRangeIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AverageTrueRangeIndicatorDescriptionMetadata.b = function (a) {
        if (AverageTrueRangeIndicatorDescriptionMetadata.a == null) {
            ...
            AverageTrueRangeIndicatorDescriptionMetadata.c(AverageTrueRangeIndicatorDescriptionMetadata.a);
        }
        if (a.j(AverageTrueRangeIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(AverageTrueRangeIndicatorDescriptionMetadata.a);
    };
    AverageTrueRangeIndicatorDescriptionMetadata.c = function (a) {
    ...
    AverageTrueRangeIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("AverageTrueRangeIndicator", function () { return new AverageTrueRangeIndicatorDescription(); });
        a.z("AverageTrueRangeIndicator", AverageTrueRangeIndicatorDescriptionMetadata.a);
    };
