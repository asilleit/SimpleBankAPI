...
var CalculatedColumnDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalculatedColumnDescriptionMetadata.b = function (a) {
        if (CalculatedColumnDescriptionMetadata.a == null) {
            ...
            CalculatedColumnDescriptionMetadata.c(CalculatedColumnDescriptionMetadata.a);
        }
        if (a.j(CalculatedColumnDescriptionMetadata.a)) {
            return;
        }
        a.y(CalculatedColumnDescriptionMetadata.a);
    };
    CalculatedColumnDescriptionMetadata.c = function (a) {
    };
    CalculatedColumnDescriptionMetadata.d = function (a) {
        CalculatedColumnDescriptionMetadata.b(a);
        a.aa("CalculatedColumn", function () { return new CalculatedColumnDescription(); });
        a.z("CalculatedColumn", CalculatedColumnDescriptionMetadata.a);
    };
