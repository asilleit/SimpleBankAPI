...
var StepLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StepLineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(StepLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(StepLineSeriesDescriptionMetadata.a);
    };
    ...
    StepLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("StepLineSeries", function () { return new StepLineSeriesDescription(); });
        a.z("StepLineSeries", StepLineSeriesDescriptionMetadata.a);
    };
