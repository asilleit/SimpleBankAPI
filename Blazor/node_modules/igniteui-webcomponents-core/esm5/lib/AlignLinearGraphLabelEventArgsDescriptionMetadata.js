...
var AlignLinearGraphLabelEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AlignLinearGraphLabelEventArgsDescriptionMetadata.b = function (a) {
        if (AlignLinearGraphLabelEventArgsDescriptionMetadata.a == null) {
            ...
            AlignLinearGraphLabelEventArgsDescriptionMetadata.c(AlignLinearGraphLabelEventArgsDescriptionMetadata.a);
        }
        if (a.j(AlignLinearGraphLabelEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(AlignLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
    AlignLinearGraphLabelEventArgsDescriptionMetadata.c = function (a) {
        FormatLinearGraphLabelEventArgsDescriptionMetadata.c(a);
    };
    AlignLinearGraphLabelEventArgsDescriptionMetadata.d = function (a) {
        AlignLinearGraphLabelEventArgsDescriptionMetadata.b(a);
        a.aa("AlignLinearGraphLabelEventArgs", function () { return new AlignLinearGraphLabelEventArgsDescription(); });
        a.z("AlignLinearGraphLabelEventArgs", AlignLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
