...
var GridFilterDialogViewModelDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogViewModelDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridFilterDialogViewModelDescriptionMetadata.a)) {
            return;
        }
        a.y(GridFilterDialogViewModelDescriptionMetadata.a);
    };
    ...
    GridFilterDialogViewModelDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridFilterDialogViewModel", function () { return new GridFilterDialogViewModelDescription(); });
        a.z("GridFilterDialogViewModel", GridFilterDialogViewModelDescriptionMetadata.a);
    };
