...
var RateOfChangeAndMomentumIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RateOfChangeAndMomentumIndicatorDescriptionMetadata.b = function (a) {
        if (RateOfChangeAndMomentumIndicatorDescriptionMetadata.a == null) {
            ...
            RateOfChangeAndMomentumIndicatorDescriptionMetadata.c(RateOfChangeAndMomentumIndicatorDescriptionMetadata.a);
        }
        if (a.j(RateOfChangeAndMomentumIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(RateOfChangeAndMomentumIndicatorDescriptionMetadata.a);
    };
    RateOfChangeAndMomentumIndicatorDescriptionMetadata.c = function (a) {
    ...
    RateOfChangeAndMomentumIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("RateOfChangeAndMomentumIndicator", function () { return new RateOfChangeAndMomentumIndicatorDescription(); });
        a.z("RateOfChangeAndMomentumIndicator", RateOfChangeAndMomentumIndicatorDescriptionMetadata.a);
    };
