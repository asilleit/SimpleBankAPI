...
var BarFragmentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BarFragmentDescriptionMetadata.b = function (a) {
        if (BarFragmentDescriptionMetadata.a == null) {
            ...
            BarFragmentDescriptionMetadata.c(BarFragmentDescriptionMetadata.a);
        }
        if (a.j(BarFragmentDescriptionMetadata.a)) {
            return;
        }
        a.y(BarFragmentDescriptionMetadata.a);
    };
    BarFragmentDescriptionMetadata.c = function (a) {
        ColumnFragmentDescriptionMetadata.c(a);
    };
    BarFragmentDescriptionMetadata.d = function (a) {
        BarFragmentDescriptionMetadata.b(a);
        a.aa("BarFragment", function () { return new BarFragmentDescription(); });
        a.z("BarFragment", BarFragmentDescriptionMetadata.a);
    };
