...
var TreemapDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TreemapDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TreemapDescriptionMetadata.a)) {
            return;
        }
        a.y(TreemapDescriptionMetadata.a);
        TreemapNodeStylingEventArgsDescriptionMetadata.d(a);
        TreemapNodePointerEventArgsDescriptionMetadata.d(a);
    };
    TreemapDescriptionMetadata.c = function (a) {
    ...
    TreemapDescriptionMetadata.d = function (a) {
        ...
        a.aa("Treemap", function () { return new TreemapDescription(); });
        a.z("Treemap", TreemapDescriptionMetadata.a);
    };
    TreemapDescriptionMetadata.e = function (a) {
