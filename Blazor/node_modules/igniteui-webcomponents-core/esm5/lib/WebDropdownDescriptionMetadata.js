...
var WebDropdownDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebDropdownDescriptionMetadata, _super);
    ...
    WebDropdownDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebDropdownDescriptionMetadata.a)) {
            return;
        }
        a.y(WebDropdownDescriptionMetadata.a);
    ...
    WebDropdownDescriptionMetadata.c = function (a) {
        ...
        a.item("KeepOpenOnSelect", "Boolean");
        a.item("Open", "Boolean");
        ...
        a.item("PositionStrategy", "ExportedType:string:DropdownPositionStrategy");
        a.item("PositionStrategy@names", "Absolute;Fixed");
        ...
        a.item("KeepOpenOnOutsideClick", "Boolean");
    ...
    WebDropdownDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebDropdown", function () { return new WebDropdownDescription(); });
        a.z("WebDropdown", WebDropdownDescriptionMetadata.a);
    };
