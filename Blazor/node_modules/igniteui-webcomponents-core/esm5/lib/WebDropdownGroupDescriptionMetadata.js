...
var WebDropdownGroupDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebDropdownGroupDescriptionMetadata, _super);
    ...
    WebDropdownGroupDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebDropdownGroupDescriptionMetadata.a)) {
            return;
        }
        a.y(WebDropdownGroupDescriptionMetadata.a);
    };
    ...
    WebDropdownGroupDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebDropdownGroup", function () { return new WebDropdownGroupDescription(); });
        a.z("WebDropdownGroup", WebDropdownGroupDescriptionMetadata.a);
    };
