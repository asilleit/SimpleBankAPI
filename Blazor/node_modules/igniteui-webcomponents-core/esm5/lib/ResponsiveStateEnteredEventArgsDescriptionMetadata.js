...
var ResponsiveStateEnteredEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ResponsiveStateEnteredEventArgsDescriptionMetadata.b = function (a) {
        if (ResponsiveStateEnteredEventArgsDescriptionMetadata.a == null) {
            ...
            ResponsiveStateEnteredEventArgsDescriptionMetadata.c(ResponsiveStateEnteredEventArgsDescriptionMetadata.a);
        }
        if (a.j(ResponsiveStateEnteredEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(ResponsiveStateEnteredEventArgsDescriptionMetadata.a);
    };
    ResponsiveStateEnteredEventArgsDescriptionMetadata.c = function (a) {
    };
    ResponsiveStateEnteredEventArgsDescriptionMetadata.d = function (a) {
        ResponsiveStateEnteredEventArgsDescriptionMetadata.b(a);
        a.aa("ResponsiveStateEnteredEventArgs", function () { return new ResponsiveStateEnteredEventArgsDescription(); });
        a.z("ResponsiveStateEnteredEventArgs", ResponsiveStateEnteredEventArgsDescriptionMetadata.a);
    };
