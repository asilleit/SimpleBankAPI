...
var ScaleLegendDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ScaleLegendDescriptionMetadata.b = function (a) {
        if (ScaleLegendDescriptionMetadata.a == null) {
            ...
            ScaleLegendDescriptionMetadata.c(ScaleLegendDescriptionMetadata.a);
        }
        if (a.j(ScaleLegendDescriptionMetadata.a)) {
            return;
        }
        a.y(ScaleLegendDescriptionMetadata.a);
    };
    ScaleLegendDescriptionMetadata.c = function (a) {
        LegendBaseDescriptionMetadata.c(a);
    };
    ScaleLegendDescriptionMetadata.d = function (a) {
        ScaleLegendDescriptionMetadata.b(a);
        a.aa("ScaleLegend", function () { return new ScaleLegendDescription(); });
        a.z("ScaleLegend", ScaleLegendDescriptionMetadata.a);
    };
