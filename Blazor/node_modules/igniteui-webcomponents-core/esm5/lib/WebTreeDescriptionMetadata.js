...
var WebTreeDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebTreeDescriptionMetadata, _super);
    ...
    WebTreeDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebTreeDescriptionMetadata.a)) {
            return;
        }
        a.y(WebTreeDescriptionMetadata.a);
    ...
    WebTreeDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebTree", function () { return new WebTreeDescription(); });
        a.z("WebTree", WebTreeDescriptionMetadata.a);
    };
