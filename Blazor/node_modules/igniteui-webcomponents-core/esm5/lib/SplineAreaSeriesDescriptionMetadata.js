...
var SplineAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineAreaSeriesDescriptionMetadata.b = function (a) {
        if (SplineAreaSeriesDescriptionMetadata.a == null) {
            ...
            SplineAreaSeriesDescriptionMetadata.c(SplineAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(SplineAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(SplineAreaSeriesDescriptionMetadata.a);
    };
    SplineAreaSeriesDescriptionMetadata.c = function (a) {
        SplineSeriesBaseDescriptionMetadata.c(a);
    };
    SplineAreaSeriesDescriptionMetadata.d = function (a) {
        SplineAreaSeriesDescriptionMetadata.b(a);
        a.aa("SplineAreaSeries", function () { return new SplineAreaSeriesDescription(); });
        a.z("SplineAreaSeries", SplineAreaSeriesDescriptionMetadata.a);
    };
