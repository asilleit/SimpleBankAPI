 ...
 * @hidden
 */
var WebGroupingDoneEventArgsDetailDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebGroupingDoneEventArgsDetailDescriptionMetadata, _super);
    function WebGroupingDoneEventArgsDetailDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WebGroupingDoneEventArgsDetailDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebGroupingDoneEventArgsDetailDescriptionMetadata.a)) {
            return;
        }
        a.y(WebGroupingDoneEventArgsDetailDescriptionMetadata.a);
        WebSortingExpressionDescriptionMetadata.d(a);
        WebColumnDescriptionMetadata.d(a);
    };
    WebGroupingDoneEventArgsDetailDescriptionMetadata.c = function (a) {
    ...
    WebGroupingDoneEventArgsDetailDescriptionMetadata.d = function (a) {
        WebGroupingDoneEventArgsDetailDescriptionMetadata.b(a);
        a.aa("WebGroupingDoneEventArgsDetail", function () { return new WebGroupingDoneEventArgsDetailDescription(); });
        a.z("WebGroupingDoneEventArgsDetail", WebGroupingDoneEventArgsDetailDescriptionMetadata.a);
    };
    WebGroupingDoneEventArgsDetailDescriptionMetadata.$t = markType(WebGroupingDoneEventArgsDetailDescriptionMetadata, 'WebGroupingDoneEventArgsDetailDescriptionMetadata');
    WebGroupingDoneEventArgsDetailDescriptionMetadata.a = null;
    return WebGroupingDoneEventArgsDetailDescriptionMetadata;
}(Base));
export { WebGroupingDoneEventArgsDetailDescriptionMetadata };
