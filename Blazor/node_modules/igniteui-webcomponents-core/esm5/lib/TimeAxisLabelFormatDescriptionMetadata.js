...
var TimeAxisLabelFormatDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TimeAxisLabelFormatDescriptionMetadata.b = function (a) {
        ...
        if (a.j(TimeAxisLabelFormatDescriptionMetadata.a)) {
            return;
        }
        a.y(TimeAxisLabelFormatDescriptionMetadata.a);
    };
    ...
    TimeAxisLabelFormatDescriptionMetadata.d = function (a) {
        ...
        a.aa("TimeAxisLabelFormat", function () { return new TimeAxisLabelFormatDescription(); });
        a.z("TimeAxisLabelFormat", TimeAxisLabelFormatDescriptionMetadata.a);
    };
