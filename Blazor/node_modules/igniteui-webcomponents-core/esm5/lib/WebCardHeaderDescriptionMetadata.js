...
var WebCardHeaderDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebCardHeaderDescriptionMetadata, _super);
    ...
    WebCardHeaderDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebCardHeaderDescriptionMetadata.a)) {
            return;
        }
        a.y(WebCardHeaderDescriptionMetadata.a);
    };
    WebCardHeaderDescriptionMetadata.c = function (a) {
        a.item("__qualifiedNameTS", "String:CardHeader");
        a.item("__tagNameWC", "String:igc-card-header");
    };
    WebCardHeaderDescriptionMetadata.d = function (a) {
        WebCardHeaderDescriptionMetadata.b(a);
        a.aa("WebCardHeader", function () { return new WebCardHeaderDescription(); });
        a.z("WebCardHeader", WebCardHeaderDescriptionMetadata.a);
    };
