...
var ResponsiveStateDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ResponsiveStateDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ResponsiveStateDescriptionMetadata.a)) {
            return;
        }
        a.y(ResponsiveStateDescriptionMetadata.a);
    ...
    ResponsiveStateDescriptionMetadata.c = function (a) {
        a.item("Name", "String");
    ...
    ResponsiveStateDescriptionMetadata.d = function (a) {
        ...
        a.aa("ResponsiveState", function () { return new ResponsiveStateDescription(); });
        a.z("ResponsiveState", ResponsiveStateDescriptionMetadata.a);
    };
