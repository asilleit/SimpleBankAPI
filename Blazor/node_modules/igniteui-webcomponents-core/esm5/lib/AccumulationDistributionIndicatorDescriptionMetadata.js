...
var AccumulationDistributionIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AccumulationDistributionIndicatorDescriptionMetadata.b = function (a) {
        if (AccumulationDistributionIndicatorDescriptionMetadata.a == null) {
            ...
            AccumulationDistributionIndicatorDescriptionMetadata.c(AccumulationDistributionIndicatorDescriptionMetadata.a);
        }
        if (a.j(AccumulationDistributionIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.y(AccumulationDistributionIndicatorDescriptionMetadata.a);
    };
    AccumulationDistributionIndicatorDescriptionMetadata.c = function (a) {
    ...
    AccumulationDistributionIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.aa("AccumulationDistributionIndicator", function () { return new AccumulationDistributionIndicatorDescription(); });
        a.z("AccumulationDistributionIndicator", AccumulationDistributionIndicatorDescriptionMetadata.a);
    };
