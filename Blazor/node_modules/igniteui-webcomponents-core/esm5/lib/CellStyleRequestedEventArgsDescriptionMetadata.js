...
var CellStyleRequestedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CellStyleRequestedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CellStyleRequestedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(CellStyleRequestedEventArgsDescriptionMetadata.a);
    };
    ...
    CellStyleRequestedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("CellStyleRequestedEventArgs", function () { return new CellStyleRequestedEventArgsDescription(); });
        a.z("CellStyleRequestedEventArgs", CellStyleRequestedEventArgsDescriptionMetadata.a);
    };
