...
var DateRangeDescriptorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(DateRangeDescriptorDescriptionMetadata, _super);
    ...
    DateRangeDescriptorDescriptionMetadata.b = function (a) {
        ...
        if (a.j(DateRangeDescriptorDescriptionMetadata.a)) {
            return;
        }
        a.y(DateRangeDescriptorDescriptionMetadata.a);
    };
    ...
    DateRangeDescriptorDescriptionMetadata.d = function (a) {
        ...
        a.aa("DateRangeDescriptor", function () { return new DateRangeDescriptorDescription(); });
        a.z("DateRangeDescriptor", DateRangeDescriptorDescriptionMetadata.a);
    };
