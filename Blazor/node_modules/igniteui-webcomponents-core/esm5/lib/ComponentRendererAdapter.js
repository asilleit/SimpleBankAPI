...
var ComponentRendererAdapter = /** @class */ /*@__PURE__*/ (function () {
    ...
    ComponentRendererAdapter.prototype.createObject = function (type, container, context) {
        ...
        if (tagName) {
            if (this._platform === "Igc") {
                var crc = IgcComponentRendererContainerComponent.fromElement(container);
                return crc.createObject(tagName);
            }
        }
        ...
        if (mustManageInMarkup && this._platform == "Igx") {
            var crc = container;
            return crc.createObject(origName, container, context);
        }
        var typeName = "Igc" + type + "Component";
        if (TypeRegistrar.isRegistered(typeName)) {
            return TypeRegistrar.create(typeName);
        }
        var shortTypeName = "Igc" + type;
    ...
    ComponentRendererAdapter.prototype.ensureExternalObject = function (target, propertyMetadata) {
        ...
        var typeName = "Igc" + owningType + "Component";
    ...
    ComponentRendererAdapter.prototype.setPropertyValue = function (target, propertyName, propertyMetadata, value, oldValue, sourceRef) {
        if (this._platform == "Igx" &&
            IgcComponentRendererContainerComponent.isEvent &&
            IgcComponentRendererContainerComponent.isEvent(target[propertyName])) {
            ...
            if (propertyMetadata &&
                ...
                if (this.isBlazorRenderer && !fromScript) {
                    if (!target.externalObject) {
                        ...
                        if (target.externalObject.i && !target.externalObject.i.nativeElement) {
                            target.externalObject.i.nativeElement = target;
                        }
                    }
    ...
    ComponentRendererAdapter.prototype.clearContainer = function (container, context, continueActions) {
        if (this._platform === "Igc") {
            var crc_1 = IgcComponentRendererContainerComponent.fromElement(container);
    ...
    ComponentRendererAdapter.prototype.getRootObject = function (container) {
        if (this._platform === "Igc") {
            var crc_2 = IgcComponentRendererContainerComponent.fromElement(container);
    ...
    ComponentRendererAdapter.prototype.replaceRootItem = function (container, type, context, continueActions) {
        ...
        if (TypeRegistrar.isRegistered(typeName)) {
            ...
            if (this._platform === "Igc") {
                var crc_3 = IgcComponentRendererContainerComponent.fromElement(container);
            ...
            if (this._platform === "Igc") {
                var crc_4 = IgcComponentRendererContainerComponent.fromElement(container);
...
var ngMarkupCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ngMarkupCollection, _super);
    ...
    ngMarkupCollection.prototype.notifyList = function () {
        ...
        qList.reset(tslib_1.__spread(items));
...
var HtmlMarkupCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(HtmlMarkupCollection, _super);
