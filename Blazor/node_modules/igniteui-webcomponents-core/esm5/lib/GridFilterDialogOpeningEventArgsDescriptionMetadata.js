...
var GridFilterDialogOpeningEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogOpeningEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridFilterDialogOpeningEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridFilterDialogOpeningEventArgsDescriptionMetadata.a);
    ...
    GridFilterDialogOpeningEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridFilterDialogOpeningEventArgs", function () { return new GridFilterDialogOpeningEventArgsDescription(); });
        a.z("GridFilterDialogOpeningEventArgs", GridFilterDialogOpeningEventArgsDescriptionMetadata.a);
    };
