...
var DataContextDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataContextDescriptionMetadata.b = function (a) {
        ...
        if (a.j(DataContextDescriptionMetadata.a)) {
            return;
        }
        a.y(DataContextDescriptionMetadata.a);
    };
    ...
    DataContextDescriptionMetadata.d = function (a) {
        ...
        a.aa("DataContext", function () { return new DataContextDescription(); });
        a.z("DataContext", DataContextDescriptionMetadata.a);
    };
