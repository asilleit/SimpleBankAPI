...
var SelectedItemsChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SelectedItemsChangedEventArgsDescriptionMetadata.b = function (a) {
        if (SelectedItemsChangedEventArgsDescriptionMetadata.a == null) {
            ...
            SelectedItemsChangedEventArgsDescriptionMetadata.c(SelectedItemsChangedEventArgsDescriptionMetadata.a);
        }
        if (a.j(SelectedItemsChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(SelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
    SelectedItemsChangedEventArgsDescriptionMetadata.c = function (a) {
        a.item("OldItems", "Collection:object:ObjectCollection:Object");
        a.item("NewItems", "Collection:object:ObjectCollection:Object");
        a.item("CurrentItems", "Collection:object:ObjectCollection:Object");
    };
    SelectedItemsChangedEventArgsDescriptionMetadata.d = function (a) {
        SelectedItemsChangedEventArgsDescriptionMetadata.b(a);
        a.aa("SelectedItemsChangedEventArgs", function () { return new SelectedItemsChangedEventArgsDescription(); });
        a.z("SelectedItemsChangedEventArgs", SelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
