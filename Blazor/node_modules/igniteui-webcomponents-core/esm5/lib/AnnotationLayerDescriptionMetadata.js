...
var AnnotationLayerDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AnnotationLayerDescriptionMetadata.b = function (a) {
        ...
        if (a.j(AnnotationLayerDescriptionMetadata.a)) {
            return;
        }
        a.y(AnnotationLayerDescriptionMetadata.a);
    };
    AnnotationLayerDescriptionMetadata.c = function (a) {
    ...
    AnnotationLayerDescriptionMetadata.d = function (a) {
        ...
        a.z("AnnotationLayer", AnnotationLayerDescriptionMetadata.a);
    };
