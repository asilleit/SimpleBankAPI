...
var NumericRadiusAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericRadiusAxisDescriptionMetadata.b = function (a) {
        if (NumericRadiusAxisDescriptionMetadata.a == null) {
            ...
            NumericRadiusAxisDescriptionMetadata.c(NumericRadiusAxisDescriptionMetadata.a);
        }
        if (a.j(NumericRadiusAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(NumericRadiusAxisDescriptionMetadata.a);
    };
    NumericRadiusAxisDescriptionMetadata.c = function (a) {
        NumericAxisBaseDescriptionMetadata.c(a);
        a.item("RadiusExtentScale", "Number:double");
        a.item("InnerRadiusExtentScale", "Number:double");
    };
    NumericRadiusAxisDescriptionMetadata.d = function (a) {
        NumericRadiusAxisDescriptionMetadata.b(a);
        a.aa("NumericRadiusAxis", function () { return new NumericRadiusAxisDescription(); });
        a.z("NumericRadiusAxis", NumericRadiusAxisDescriptionMetadata.a);
    };
