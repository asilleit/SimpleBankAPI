...
var AxisRangeChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisRangeChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(AxisRangeChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(AxisRangeChangedEventArgsDescriptionMetadata.a);
    };
    ...
    AxisRangeChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("AxisRangeChangedEventArgs", function () { return new AxisRangeChangedEventArgsDescription(); });
        a.z("AxisRangeChangedEventArgs", AxisRangeChangedEventArgsDescriptionMetadata.a);
    };
