...
var PolarLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarLineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(PolarLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(PolarLineSeriesDescriptionMetadata.a);
    };
    ...
    PolarLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("PolarLineSeries", function () { return new PolarLineSeriesDescription(); });
        a.z("PolarLineSeries", PolarLineSeriesDescriptionMetadata.a);
    };
