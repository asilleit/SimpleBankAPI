...
var WebListDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebListDescriptionMetadata, _super);
    ...
    WebListDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebListDescriptionMetadata.a)) {
            return;
        }
        a.y(WebListDescriptionMetadata.a);
    };
    ...
    WebListDescriptionMetadata.d = function (a) {
        ...
        a.aa("WebList", function () { return new WebListDescription(); });
        a.z("WebList", WebListDescriptionMetadata.a);
    };
