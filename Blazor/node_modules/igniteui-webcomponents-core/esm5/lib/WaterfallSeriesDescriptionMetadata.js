...
var WaterfallSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WaterfallSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WaterfallSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(WaterfallSeriesDescriptionMetadata.a);
    };
    WaterfallSeriesDescriptionMetadata.c = function (a) {
    ...
    WaterfallSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("WaterfallSeries", function () { return new WaterfallSeriesDescription(); });
        a.z("WaterfallSeries", WaterfallSeriesDescriptionMetadata.a);
    };
