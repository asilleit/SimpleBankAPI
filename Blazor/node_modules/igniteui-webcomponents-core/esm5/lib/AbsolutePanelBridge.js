...
var AbsolutePanelBridge = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(AbsolutePanelBridge, _super);
    ...
    AbsolutePanelBridge.prototype.getX = function (a, b) {
        var c = b.v.getStyleProperty("left");
        stringReplace(c, "px", "");
        var d = parseFloat(c);
        return d;
    };
    AbsolutePanelBridge.prototype.getY = function (a, b) {
        var c = b.v.getStyleProperty("top");
        stringReplace(c, "px", "");
        var d = parseFloat(c);
        return d;
    };
    ...
    AbsolutePanelBridge.prototype.setX = function (a, b, c) {
        b.v.setStyleProperty("left", c.toString() + "px");
    };
    AbsolutePanelBridge.prototype.setY = function (a, b, c) {
        b.v.setStyleProperty("top", c.toString() + "px");
    };
