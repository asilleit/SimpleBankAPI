...
var LabelClickEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LabelClickEventArgsDescriptionMetadata.b = function (a) {
        if (LabelClickEventArgsDescriptionMetadata.a == null) {
            ...
            LabelClickEventArgsDescriptionMetadata.c(LabelClickEventArgsDescriptionMetadata.a);
        }
        if (a.j(LabelClickEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(LabelClickEventArgsDescriptionMetadata.a);
    };
    LabelClickEventArgsDescriptionMetadata.c = function (a) {
        a.item("AllowSliceClick", "Boolean");
    };
    LabelClickEventArgsDescriptionMetadata.d = function (a) {
        LabelClickEventArgsDescriptionMetadata.b(a);
        a.aa("LabelClickEventArgs", function () { return new LabelClickEventArgsDescription(); });
        a.z("LabelClickEventArgs", LabelClickEventArgsDescriptionMetadata.a);
    };
