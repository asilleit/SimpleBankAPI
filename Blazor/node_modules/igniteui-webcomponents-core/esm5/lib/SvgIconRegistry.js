...
var SvgIconRegistry = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(SvgIconRegistry, _super);
    function SvgIconRegistry() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.c = new Dictionary$2(String_$type, SvgIconCollection.$, 0);
        return _this;
    }
    Object.defineProperty(SvgIconRegistry, "instance", {
        get: function () {
            if (SvgIconRegistry.a == null) {
                SvgIconRegistry.a = new SvgIconRegistry();
            }
            return SvgIconRegistry.a;
        },
        enumerable: true,
        configurable: true
    });
