...
var ColumnFragmentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnFragmentDescriptionMetadata.b = function (a) {
        if (ColumnFragmentDescriptionMetadata.a == null) {
            ...
            ColumnFragmentDescriptionMetadata.c(ColumnFragmentDescriptionMetadata.a);
        }
        if (a.j(ColumnFragmentDescriptionMetadata.a)) {
            return;
        }
        a.y(ColumnFragmentDescriptionMetadata.a);
    };
    ColumnFragmentDescriptionMetadata.c = function (a) {
    ...
    ColumnFragmentDescriptionMetadata.d = function (a) {
        ...
        a.aa("ColumnFragment", function () { return new ColumnFragmentDescription(); });
        a.z("ColumnFragment", ColumnFragmentDescriptionMetadata.a);
    };
