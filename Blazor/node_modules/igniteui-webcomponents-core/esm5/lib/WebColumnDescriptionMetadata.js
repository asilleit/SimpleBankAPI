...
import { WebSummaryOperandDescriptionMetadata } from "./WebSummaryOperandDescriptionMetadata";
import { WebColumnDescription } from "./WebColumnDescription";
/**
 * @hidden
 */
var WebColumnDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(WebColumnDescriptionMetadata, _super);
    function WebColumnDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WebColumnDescriptionMetadata.b = function (a) {
        ...
        if (a.j(WebColumnDescriptionMetadata.a)) {
            return;
        }
        a.y(WebColumnDescriptionMetadata.a);
        ...
        WebSummaryOperandDescriptionMetadata.d(a);
    };
    WebColumnDescriptionMetadata.c = function (a) {
        ...
        a.item("DataType@names", "String;Number;Boolean;Date;DateTime;Time;Currency;Percent");
        ...
        a.item("SummaryFormatterRef", "EventRef::summaryFormatter");
        WebColumnDescriptionMetadata.e(a);
    };
    WebColumnDescriptionMetadata.d = function (a) {
        WebColumnDescriptionMetadata.b(a);
        a.aa("WebColumn", function () { return new WebColumnDescription(); });
        a.z("WebColumn", WebColumnDescriptionMetadata.a);
    };
    WebColumnDescriptionMetadata.e = function (a) {
        a.item("__qualifiedNameNG", "String:Column");
        a.item("__tagNameWCSubstitutable", "String:igc-column-group,igc-column-layout");
    };
    WebColumnDescriptionMetadata.$t = markType(WebColumnDescriptionMetadata, 'WebColumnDescriptionMetadata');
    WebColumnDescriptionMetadata.a = null;
    return WebColumnDescriptionMetadata;
}(Base));
export { WebColumnDescriptionMetadata };
