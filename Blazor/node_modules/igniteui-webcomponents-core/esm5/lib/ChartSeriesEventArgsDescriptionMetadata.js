...
var ChartSeriesEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ChartSeriesEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ChartSeriesEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(ChartSeriesEventArgsDescriptionMetadata.a);
    ...
    ChartSeriesEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("ChartSeriesEventArgs", function () { return new ChartSeriesEventArgsDescription(); });
        a.z("ChartSeriesEventArgs", ChartSeriesEventArgsDescriptionMetadata.a);
    };
