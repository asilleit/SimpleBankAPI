...
var DataSourceSchemaChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataSourceSchemaChangedEventArgsDescriptionMetadata.b = function (a) {
        if (DataSourceSchemaChangedEventArgsDescriptionMetadata.a == null) {
            ...
            DataSourceSchemaChangedEventArgsDescriptionMetadata.c(DataSourceSchemaChangedEventArgsDescriptionMetadata.a);
        }
        if (a.j(DataSourceSchemaChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(DataSourceSchemaChangedEventArgsDescriptionMetadata.a);
    };
    DataSourceSchemaChangedEventArgsDescriptionMetadata.c = function (a) {
    };
    DataSourceSchemaChangedEventArgsDescriptionMetadata.d = function (a) {
        DataSourceSchemaChangedEventArgsDescriptionMetadata.b(a);
        a.aa("DataSourceSchemaChangedEventArgs", function () { return new DataSourceSchemaChangedEventArgsDescription(); });
        a.z("DataSourceSchemaChangedEventArgs", DataSourceSchemaChangedEventArgsDescriptionMetadata.a);
    };
