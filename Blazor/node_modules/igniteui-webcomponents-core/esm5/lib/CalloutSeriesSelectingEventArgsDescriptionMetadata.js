...
var CalloutSeriesSelectingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutSeriesSelectingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(CalloutSeriesSelectingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(CalloutSeriesSelectingEventArgsDescriptionMetadata.a);
        SeriesDescriptionMetadata.d(a);
    };
    CalloutSeriesSelectingEventArgsDescriptionMetadata.c = function (a) {
    ...
    CalloutSeriesSelectingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("CalloutSeriesSelectingEventArgs", function () { return new CalloutSeriesSelectingEventArgsDescription(); });
        a.z("CalloutSeriesSelectingEventArgs", CalloutSeriesSelectingEventArgsDescriptionMetadata.a);
    };
