...
var RadialLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialLineSeriesDescriptionMetadata.b = function (a) {
        if (RadialLineSeriesDescriptionMetadata.a == null) {
            ...
            RadialLineSeriesDescriptionMetadata.c(RadialLineSeriesDescriptionMetadata.a);
        }
        if (a.j(RadialLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(RadialLineSeriesDescriptionMetadata.a);
    };
    RadialLineSeriesDescriptionMetadata.c = function (a) {
    ...
    RadialLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("RadialLineSeries", function () { return new RadialLineSeriesDescription(); });
        a.z("RadialLineSeries", RadialLineSeriesDescriptionMetadata.a);
    };
