...
var PropertyReferenceFilterExpressionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PropertyReferenceFilterExpressionDescriptionMetadata.b = function (a) {
        ...
        if (a.j(PropertyReferenceFilterExpressionDescriptionMetadata.a)) {
            return;
        }
        a.y(PropertyReferenceFilterExpressionDescriptionMetadata.a);
    };
    ...
    PropertyReferenceFilterExpressionDescriptionMetadata.d = function (a) {
        ...
        a.aa("PropertyReferenceFilterExpression", function () { return new PropertyReferenceFilterExpressionDescription(); });
        a.z("PropertyReferenceFilterExpression", PropertyReferenceFilterExpressionDescriptionMetadata.a);
    };
