...
var NumericAngleAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericAngleAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.j(NumericAngleAxisDescriptionMetadata.a)) {
            return;
        }
        a.y(NumericAngleAxisDescriptionMetadata.a);
    };
    ...
    NumericAngleAxisDescriptionMetadata.d = function (a) {
        ...
        a.aa("NumericAngleAxis", function () { return new NumericAngleAxisDescription(); });
        a.z("NumericAngleAxis", NumericAngleAxisDescriptionMetadata.a);
    };
