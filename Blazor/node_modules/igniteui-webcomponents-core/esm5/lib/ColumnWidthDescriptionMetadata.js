...
var ColumnWidthDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnWidthDescriptionMetadata.b = function (a) {
        ...
        if (a.j(ColumnWidthDescriptionMetadata.a)) {
            return;
        }
        a.y(ColumnWidthDescriptionMetadata.a);
    };
    ...
    ColumnWidthDescriptionMetadata.d = function (a) {
        ...
        a.aa("ColumnWidth", function () { return new ColumnWidthDescription(); });
        a.z("ColumnWidth", ColumnWidthDescriptionMetadata.a);
    };
