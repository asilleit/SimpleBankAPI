...
var PointSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PointSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.j(PointSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(PointSeriesDescriptionMetadata.a);
    };
    ...
    PointSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("PointSeries", function () { return new PointSeriesDescription(); });
        a.z("PointSeries", PointSeriesDescriptionMetadata.a);
    };
