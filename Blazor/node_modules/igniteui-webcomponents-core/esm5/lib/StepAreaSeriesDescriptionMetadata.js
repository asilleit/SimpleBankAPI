...
var StepAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StepAreaSeriesDescriptionMetadata.b = function (a) {
        if (StepAreaSeriesDescriptionMetadata.a == null) {
            ...
            StepAreaSeriesDescriptionMetadata.c(StepAreaSeriesDescriptionMetadata.a);
        }
        if (a.j(StepAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.y(StepAreaSeriesDescriptionMetadata.a);
    };
    StepAreaSeriesDescriptionMetadata.c = function (a) {
    ...
    StepAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.aa("StepAreaSeries", function () { return new StepAreaSeriesDescription(); });
        a.z("StepAreaSeries", StepAreaSeriesDescriptionMetadata.a);
    };
