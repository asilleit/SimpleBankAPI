...
var GridAnimationPhaseSettingsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridAnimationPhaseSettingsDescriptionMetadata.b = function (a) {
        ...
        if (a.j(GridAnimationPhaseSettingsDescriptionMetadata.a)) {
            return;
        }
        a.y(GridAnimationPhaseSettingsDescriptionMetadata.a);
    };
    ...
    GridAnimationPhaseSettingsDescriptionMetadata.d = function (a) {
        ...
        a.aa("GridAnimationPhaseSettings", function () { return new GridAnimationPhaseSettingsDescription(); });
        a.z("GridAnimationPhaseSettings", GridAnimationPhaseSettingsDescriptionMetadata.a);
    };
