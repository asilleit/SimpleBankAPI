...
var BollingerBandsOverlayDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BollingerBandsOverlayDescriptionMetadata.b = function (a) {
        ...
        if (a.j(BollingerBandsOverlayDescriptionMetadata.a)) {
            return;
        }
        a.y(BollingerBandsOverlayDescriptionMetadata.a);
    };
    ...
    BollingerBandsOverlayDescriptionMetadata.d = function (a) {
        ...
        a.aa("BollingerBandsOverlay", function () { return new BollingerBandsOverlayDescription(); });
        a.z("BollingerBandsOverlay", BollingerBandsOverlayDescriptionMetadata.a);
    };
