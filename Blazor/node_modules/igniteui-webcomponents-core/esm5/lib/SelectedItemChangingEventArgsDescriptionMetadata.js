...
var SelectedItemChangingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SelectedItemChangingEventArgsDescriptionMetadata.b = function (a) {
        if (SelectedItemChangingEventArgsDescriptionMetadata.a == null) {
            ...
            SelectedItemChangingEventArgsDescriptionMetadata.c(SelectedItemChangingEventArgsDescriptionMetadata.a);
        }
        if (a.j(SelectedItemChangingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.y(SelectedItemChangingEventArgsDescriptionMetadata.a);
    };
    SelectedItemChangingEventArgsDescriptionMetadata.c = function (a) {
        SelectedItemChangedEventArgsDescriptionMetadata.c(a);
    ...
    SelectedItemChangingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.aa("SelectedItemChangingEventArgs", function () { return new SelectedItemChangingEventArgsDescription(); });
        a.z("SelectedItemChangingEventArgs", SelectedItemChangingEventArgsDescriptionMetadata.a);
    };
