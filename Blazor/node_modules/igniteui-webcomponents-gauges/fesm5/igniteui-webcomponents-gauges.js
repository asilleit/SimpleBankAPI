...
import { PathGeometry, PathFigure, LineSegment, Point_$type, BrushUtil, markType, Base, List$1, GeometryUtil, ArcSegment, Size, PolyLineSegment, InterpolationUtil, markEnum, PropertyChangedEventArgs, DependencyObject, INotifyPropertyChanged_$type, markDep, DependencyProperty, PropertyMetadata, Brush, ObservableCollection$1, EventArgs, fromEnum, StringBuilder, PointData, SizeData, String_$type, typeCast, TextBlock, Path, delegateCombine, runOn, Rect, DoubleAnimator, StackPool$1, RectData, AppearanceHelper, PathVisualData, GetPointsSettings, PolygonUtil, isNaN_, Number_$type, Tuple$2, DeviceUtils, delegateRemove, BindingFormatter, fromEn, FontUtil, Control, Array_$type, enumGetBox, BrushCollection, Dictionary$2, CanvasGestureDOMEventProxy, intDivide, arrayCopy1, RenderingContext, CanvasViewRenderer, TypeRegistrar, EventProxy, truncate, stringIsNullOrEmpty, FontDefaults, NamePatcher, toSpinal, getAllPropertyNames, fromSpinal, RegisterElementHelper, brushToString, stringToBrush, initializePropertiesFromCss, IgcHTMLElement, SyncableObservableCollection$2, IgCollection, WebComponentRenderer, CollectionAdapter, NotifyCollectionChangedAction, WebComponentWrapper, IgcDataContext, ensureEnum, enumToString, fromBrushCollection, toBrushCollection, brushCollectionToString, ensureBool, arrayFindByName, toPoint, IgcNumberFormatSpecifierModule, IgcDVInteractivityModule, DoubleValueChangedEventArgs, IgcDoubleValueChangedEventArgs, isInfinity, MathUtil, PathSegment, Stack$1, TransformGroup, RotateTransform, SweepDirection_$type, Delegate_$type, fromPoint } from 'igniteui-webcomponents-core';
...
var XamBulletGraph = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    XamBulletGraph.prototype.fp = function (a, b) {
        ...
        if (d.count > 0) {
            var e = PolygonUtil.b(this.be(d._inner[0]), a);
            if (e == true) {
        ...
        if (g.count > 0) {
            var h = PolygonUtil.b(this.be(g._inner[0]), a);
            if (h == true) {
        ...
        for (var i = 0; i < this.bb.count; i++) {
            ...
            if (k.count > 0) {
                var l = PolygonUtil.b(this.be(k._inner[0]), a);
                if (l == true) {
...
var IgcAlignLinearGraphLabelEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcAlignLinearGraphLabelEventArgs, _super);
...
var IgcLinearGraphRangeComponent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcLinearGraphRangeComponent, _super);
...
var IgcLinearGraphRangeCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcLinearGraphRangeCollection, _super);
    function IgcLinearGraphRangeCollection(list) {
        var _this = _super.call(this) || this;
        if (!IgcLinearGraphRangeComponent.$type) {
            IgcLinearGraphRangeComponent.$type = markType(IgcLinearGraphRangeComponent, "IgcLinearGraphRangeComponent");
        }
        if (list) {
    ...
    IgcLinearGraphRangeCollection.prototype._createInnerColl = function () {
        ...
        var coll = new SyncableObservableCollection$2(IgcLinearGraphRangeComponent.$type, XamLinearGraphRange.$type, 0);
...
var IgcBulletGraphComponent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcBulletGraphComponent, _super);
...
var IgcLinearGraphRangeModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcLinearGraphRangeModule.register = function () {
        ...
        TypeRegistrar.registerCons('IgcLinearGraphRangeComponent', IgcLinearGraphRangeComponent);
    };
...
var IgcBulletGraphCoreModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcBulletGraphCoreModule.register = function () {
        ...
        TypeRegistrar.registerCons('IgcBulletGraphComponent', IgcBulletGraphComponent);
        IgcLinearGraphRangeModule.register();
        IgcNumberFormatSpecifierModule.register();
    };
...
var IgcBulletGraphModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcBulletGraphModule.register = function () {
        ...
        IgcDVInteractivityModule.register();
    };
...
var XamLinearGauge = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    XamLinearGauge.prototype.bb = function (a) {
        ...
        return PolygonUtil.b(this.bk, a);
    };
    XamLinearGauge.prototype.needleContainsPoint = function (a, b) {
        if (this.bk == null) {
            return false;
        }
        return b ? this.h4.containsPoint(a) : PolygonUtil.b(this.bk, a);
    };
    ...
    XamLinearGauge.prototype.f0 = function (a, b) {
        ...
        for (var e = 0; e < this.bh.count; e++) {
            ...
            var g = f.getPoints(new GetPointsSettings());
            if (g.count > 0) {
                var h = PolygonUtil.b(this.bl(g._inner[0]), a);
                if (h == true) {
...
var IgcLinearGaugeComponent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcLinearGaugeComponent, _super);
    function IgcLinearGaugeComponent() {
        ...
        */
        ...
        _this._renderer = new WebComponentRenderer(_this, document, true, LinearGaugeStylingDefaults);
        _this._implementation = _this.createImplementation();
        _this._container = _this._renderer.createElement("div");
        _this._renderer.updateRoot(_this._container);
        //this._renderer.rootWrapper.append(this._container);
    ...
    Object.defineProperty(IgcLinearGaugeComponent, "observedAttributes", {
        get: function () {
            if (IgcLinearGaugeComponent._observedAttributesIgcLinearGaugeComponent == null) {
                var names = getAllPropertyNames(IgcLinearGaugeComponent);
                for (var i = 0; i < names.length; i++) {
                    names[i] = toSpinal(names[i]);
                }
        ...
        */
        ...
        set: function (ev) {
            ...
            this._valueChanged_wrapped = function (o, e) {
                var outerArgs = new IgcDoubleValueChangedEventArgs();
                outerArgs._provideImplementation(e);
...
var IgcLinearGaugeCoreModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcLinearGaugeCoreModule.register = function () {
        ...
        TypeRegistrar.registerCons('IgcLinearGaugeComponent', IgcLinearGaugeComponent);
        IgcLinearGraphRangeModule.register();
        IgcNumberFormatSpecifierModule.register();
    };
...
var BackingFrame = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BackingFrame.prototype.j = function (a, b, c, d) {
        ...
        var as = GeometryUtil.k(ao, an, { $type: Point_$type, x: c, y: d }, r);
        ...
        var a0 = GeometryUtil.k(aw, av, { $type: Point_$type, x: c, y: d }, r);
        if (isNaN_(as.c.x) || isNaN_(as.c.y) || isNaN_(as.d.x) || isNaN_(as.d.y) || isNaN_(a0.c.x) || isNaN_(a0.c.y) || isNaN_(a0.d.x) || isNaN_(a0.d.y)) {
            ...
            if ((Math.pow(a3_1.x - an.x, 2) + Math.pow(a3_1.y - an.y, 2)) <= (Math.pow(a2_1.x - an.x, 2) + Math.pow(a2_1.y - an.y, 2))) {
                ...
                a._segments.add(a5);
                var a6_1 = GeometryUtil.f({ $type: Point_$type, x: c, y: d }, a2_1);
                var a7_1 = GeometryUtil.f({ $type: Point_$type, x: c, y: d }, a3_1);
                while (a7_1 < a6_1) {
                    a7_1 += 2 * Math.PI;
                }
                var a8 = ((function () {
...
var RadialGaugeNeedlePreparer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialGaugeNeedlePreparer.prototype.f = function (a, b, c, d, e) {
        ...
        var aa = f.c == 2;
        if (h) {
            var ab = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: 0, y: 0 }, l);
        ...
        if (aa) {
            var af = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: 0, y: 0 }, t);
        ...
        var aw = z;
        if (ai) {
            var ax = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: o, y: 0 }, q);
...
var XamRadialGauge = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    XamRadialGauge.prototype.b5 = function (a) {
        ...
        var e = d.x;
        var f = d.y;
        var g = GeometryUtil.f({ $type: Point_$type, x: e, y: f }, a);
    ...
    XamRadialGauge.prototype.bc = function (a) {
        ...
        return PolygonUtil.b(this.bj, a);
    };
    XamRadialGauge.prototype.needleContainsPoint = function (a, b) {
        if (this.bj == null) {
            return false;
        }
        return b ? PolygonUtil.b(this.bk, a) : PolygonUtil.b(this.bj, a);
    };
    ...
    XamRadialGauge.prototype.gb = function (a) {
        ...
        if (aa != 0 && !ai && ab) {
            ...
            var be = GeometryUtil.k(bd, { $type: Point_$type, x: ar, y: as }, { $type: Point_$type, x: ae, y: af }, ac * k);
            var bf = au;
            var bg = av;
            if (a8 - a6 != 0) {
                bg = ae;
            ...
            var bj = GeometryUtil.k(bi, { $type: Point_$type, x: av, y: aw }, { $type: Point_$type, x: ae, y: af }, ac * k);
            if (isNaN_(be.c.x) || isNaN_(be.c.y) || isNaN_(be.d.x) || isNaN_(be.d.y) || isNaN_(bj.c.x) || isNaN_(bj.c.y) || isNaN_(bj.d.x) || isNaN_(bj.d.y)) {
                ...
                if ((Math.pow(bl.x - ar, 2) + Math.pow(bl.y - as, 2)) <= (Math.pow(bk.x - ar, 2) + Math.pow(bk.y - as, 2))) {
                    ...
                    var bm = GeometryUtil.f({ $type: Point_$type, x: ae, y: af }, bk);
                    var bn = GeometryUtil.f({ $type: Point_$type, x: ae, y: af }, bl);
                    var bo = q;
                    var bp = r;
                    while (bo > Math.PI * 2) {
                        bo -= Math.PI * 2;
...
var IgcAlignRadialGaugeLabelEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcAlignRadialGaugeLabelEventArgs, _super);
...
var IgcRadialGaugeRangeComponent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcRadialGaugeRangeComponent, _super);
    ...
    Object.defineProperty(IgcRadialGaugeRangeComponent, "observedAttributes", {
        get: function () {
            if (IgcRadialGaugeRangeComponent._observedAttributesIgcRadialGaugeRangeComponent == null) {
                var names = getAllPropertyNames(IgcRadialGaugeRangeComponent);
                for (var i = 0; i < names.length; i++) {
                    names[i] = toSpinal(names[i]);
                }
...
var IgcRadialGaugeRangeCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcRadialGaugeRangeCollection, _super);
    function IgcRadialGaugeRangeCollection(list) {
        var _this = _super.call(this) || this;
        if (!IgcRadialGaugeRangeComponent.$type) {
            IgcRadialGaugeRangeComponent.$type = markType(IgcRadialGaugeRangeComponent, "IgcRadialGaugeRangeComponent");
        }
        if (list) {
            for (var i = 0; i < list.length; i++) {
                _this.add(list[i]);
    ...
    IgcRadialGaugeRangeCollection.prototype._createInnerColl = function () {
        ...
        var coll = new SyncableObservableCollection$2(IgcRadialGaugeRangeComponent.$type, XamRadialGaugeRange.$type, 0);
        coll.compare = function (ext, int) {
            var comp = ext;
            if (comp._implementation) {
                comp = comp._implementation;
...
var IgcRadialGaugeComponent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgcRadialGaugeComponent, _super);
    function IgcRadialGaugeComponent() {
        ...
        */
        ...
        _this._renderer = new WebComponentRenderer(_this, document, true, RadialGaugeStylingDefaults);
        _this._implementation = _this.createImplementation();
        _this._container = _this._renderer.createElement("div");
        _this._renderer.updateRoot(_this._container);
        //this._renderer.rootWrapper.append(this._container);
    ...
    Object.defineProperty(IgcRadialGaugeComponent, "observedAttributes", {
        get: function () {
            if (IgcRadialGaugeComponent._observedAttributesIgcRadialGaugeComponent == null) {
                var names = getAllPropertyNames(IgcRadialGaugeComponent);
                for (var i = 0; i < names.length; i++) {
                    names[i] = toSpinal(names[i]);
                }
    ...
    IgcRadialGaugeComponent.register = function () {
        if (!IgcRadialGaugeComponent._isElementRegistered) {
            ...
            RegisterElementHelper.registerElement(IgcRadialGaugeComponent.htmlTagName, IgcRadialGaugeComponent);
        }
    };
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "scaleSweepDirection", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("scaleSweepDirection", enumToString(SweepDirection_$type, this.i.ii));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needleBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needleBrush", brushToString(this.i.ib));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needleOutline", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needleOutline", brushToString(this.i.ic));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needleShape", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needleShape", enumToString(RadialGaugeNeedleShape_$type, this.i.ar));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needlePivotShape", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needlePivotShape", enumToString(RadialGaugePivotShape_$type, this.i.as));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needlePivotBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needlePivotBrush", brushToString(this.i.id));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "needlePivotOutline", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("needlePivotOutline", brushToString(this.i.ie));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "tickBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("tickBrush", brushToString(this.i.ih));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "fontBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("fontBrush", brushToString(this.i.h8));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "minorTickBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("minorTickBrush", brushToString(this.i.ia));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "scaleBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("scaleBrush", brushToString(this.i.ig));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "backingBrush", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("backingBrush", brushToString(this.i.h6));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "backingOutline", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("backingOutline", brushToString(this.i.h7));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "scaleOversweepShape", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("scaleOversweepShape", enumToString(RadialGaugeScaleOversweepShape_$type, this.i.au));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "backingShape", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("backingShape", enumToString(RadialGaugeBackingShape_$type, this.i.am));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgcRadialGaugeComponent.prototype, "duplicateLabelOmissionStrategy", {
        ...
        */
        ...
        set: function (v) {
            ...
            this._a("duplicateLabelOmissionStrategy", enumToString(RadialGaugeDuplicateLabelOmissionStrategy_$type, this.i.an));
        },
        enumerable: true,
        configurable: true
    });
...
var IgcRadialGaugeRangeModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcRadialGaugeRangeModule.register = function () {
        ...
        TypeRegistrar.registerCons('IgcRadialGaugeRangeComponent', IgcRadialGaugeRangeComponent);
    };
...
var IgcRadialGaugeCoreModule = /** @class */ /*@__PURE__*/ (function () {
    ...
    IgcRadialGaugeCoreModule.register = function () {
        ...
        TypeRegistrar.registerCons('IgcRadialGaugeComponent', IgcRadialGaugeComponent);
