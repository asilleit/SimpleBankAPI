...
import { IgcFormatRadialGaugeLabelEventArgs } from './igc-format-radial-gauge-label-event-args';
import { IgcAlignRadialGaugeLabelEventArgs } from './igc-align-radial-gauge-label-event-args';
import { IgcRadialGaugeRangeCollection } from './igc-radial-gauge-range-collection';
import { IgcRadialGaugeRangeComponent } from './igc-radial-gauge-range-component';
import { IgcDoubleValueChangedEventArgs } from "igniteui-webcomponents-core";
import { IgcHTMLElement } from "igniteui-webcomponents-core";
export declare class IgcRadialGaugeComponent extends IgcHTMLElement {
    private _height;
    private _width;
    height: string;
    width: string;
    ...
    */
    readonly ranges: IgcRadialGaugeRangeCollection;
    private _renderer;
    constructor();
    destroy(): void;
    private updateContentRanges;
    private _wrapper;
    ...
    readonly i: XamRadialGauge; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgcRadialGaugeComponent;
    ...
    private static _observedAttributesIgcRadialGaugeComponent;
...
*/
    ...
    */
    formatLabel: (s: IgcRadialGaugeComponent, e: IgcFormatRadialGaugeLabelEventArgs) => void;
    private _alignLabel;
    ...
    */
    alignLabel: (s: IgcRadialGaugeComponent, e: IgcAlignRadialGaugeLabelEventArgs) => void;
    private _valueChanged;
    private _valueChanged_wrapped;
    /**
     * Occurs when the Value property changes.
    */
    valueChanged: (s: IgcRadialGaugeComponent, e: IgcDoubleValueChangedEventArgs) => void;
    private _actualMinimumValueChange;
    private _actualMinimumValueChange_wrapped;
    actualMinimumValueChange: (s: IgcRadialGaugeComponent, e: number) => void;
    private _actualMaximumValueChange;
    private _actualMaximumValueChange_wrapped;
    actualMaximumValueChange: (s: IgcRadialGaugeComponent, e: number) => void;
}
