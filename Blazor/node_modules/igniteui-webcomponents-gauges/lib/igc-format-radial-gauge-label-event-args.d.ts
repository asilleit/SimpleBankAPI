...
*/
export declare class IgcFormatRadialGaugeLabelEventArgs {
    protected createImplementation(): FormatRadialGaugeLabelEventArgs_internal;
    protected _implementation: any;
    readonly i: FormatRadialGaugeLabelEventArgs_internal;
    private onImplementationCreated;
    constructor();
    protected _provideImplementation(i: any): void;
    readonly actualMinimumValue: number;
    readonly actualMaximumValue: number;
