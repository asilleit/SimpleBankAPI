...
export declare class IgcBulletGraphComponent extends IgcHTMLElement {
    private _height;
    private _width;
    height: string;
    width: string;
    ...
    */
    readonly ranges: IgcLinearGraphRangeCollection;
    private _renderer;
    constructor();
    destroy(): void;
     ...
     * @hidden
     */
    readonly i: XamBulletGraph; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgcBulletGraphComponent;
    ...
    private static _observedAttributesIgcBulletGraphComponent;
...
*/
    ...
    */
    formatLabel: (s: IgcBulletGraphComponent, e: IgcFormatLinearGraphLabelEventArgs) => void;
    private _alignLabel;
    ...
    */
    alignLabel: (s: IgcBulletGraphComponent, e: IgcAlignLinearGraphLabelEventArgs) => void;
    private _actualMinimumValueChange;
    private _actualMinimumValueChange_wrapped;
    actualMinimumValueChange: (s: IgcBulletGraphComponent, e: number) => void;
    private _actualMaximumValueChange;
    private _actualMaximumValueChange_wrapped;
    actualMaximumValueChange: (s: IgcBulletGraphComponent, e: number) => void;
}
