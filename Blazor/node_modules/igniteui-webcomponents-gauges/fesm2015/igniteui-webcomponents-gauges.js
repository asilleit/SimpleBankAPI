...
let XamBulletGraph = /*@__PURE__*/ (() => {
    class XamBulletGraph extends Control {
        ...
        fp(a, b) {
            ...
            if (d.count > 0) {
                let e = PolygonUtil.b(this.be(d._inner[0]), a);
                if (e == true) {
            ...
            if (g.count > 0) {
                let h = PolygonUtil.b(this.be(g._inner[0]), a);
                if (h == true) {
            ...
            for (let i = 0; i < this.bb.count; i++) {
                ...
                if (k.count > 0) {
                    let l = PolygonUtil.b(this.be(k._inner[0]), a);
                    if (l == true) {
...
*/
class IgcFormatLinearGraphLabelEventArgs {
...
*/
class IgcAlignLinearGraphLabelEventArgs extends IgcFormatLinearGraphLabelEventArgs {
    createImplementation() {
...
let IgcLinearGraphRangeComponent = /*@__PURE__*/ (() => {
    class IgcLinearGraphRangeComponent extends IgcHTMLElement {
        constructor() {
            super();
            this._renderer = null;
        ...
        static get observedAttributes() {
            if (IgcLinearGraphRangeComponent._observedAttributesIgcLinearGraphRangeComponent == null) {
                let names = getAllPropertyNames(IgcLinearGraphRangeComponent);
...
class IgcLinearGraphRangeCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgcLinearGraphRangeComponent.$type, XamLinearGraphRange.$type, 0);
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE:  you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
let IgcBulletGraphComponent = /*@__PURE__*/ (() => {
    class IgcBulletGraphComponent extends IgcHTMLElement {
        constructor() {
            super();
            this.contentRanges = [];
            /**
            ...
            */
            ...
            this._renderer = new WebComponentRenderer(this, document, true, BulletGraphStylingDefaults);
            this._implementation = this.createImplementation();
        ...
        */
        ...
        static get observedAttributes() {
            if (IgcBulletGraphComponent._observedAttributesIgcBulletGraphComponent == null) {
                let names = getAllPropertyNames(IgcBulletGraphComponent);
                for (let i = 0; i < names.length; i++) {
                    names[i] = toSpinal(names[i]);
                }
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE: you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
class IgcLinearGraphRangeModule {
    static register() {
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE: you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
class IgcBulletGraphCoreModule {
    static register() {
    ...
    class XamLinearGauge extends Control {
        ...
        f0(a, b) {
            ...
            for (let e = 0; e < this.bh.count; e++) {
                ...
                let g = f.getPoints(new GetPointsSettings());
                if (g.count > 0) {
                    let h = PolygonUtil.b(this.bl(g._inner[0]), a);
                    if (h == true) {
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE:  you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
let IgcLinearGaugeComponent = /*@__PURE__*/ (() => {
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE: you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
class IgcLinearGaugeCoreModule {
    static register() {
...
let BackingFrame = /*@__PURE__*/ (() => {
    class BackingFrame extends Base {
        ...
        j(a, b, c, d) {
            ...
            let as = GeometryUtil.k(ao, an, { $type: Point_$type, x: c, y: d }, r);
            ...
            let a0 = GeometryUtil.k(aw, av, { $type: Point_$type, x: c, y: d }, r);
            if (isNaN_(as.c.x) || isNaN_(as.c.y) || isNaN_(as.d.x) || isNaN_(as.d.y) || isNaN_(a0.c.x) || isNaN_(a0.c.y) || isNaN_(a0.d.x) || isNaN_(a0.d.y)) {
                ...
                if ((Math.pow(a3.x - an.x, 2) + Math.pow(a3.y - an.y, 2)) <= (Math.pow(a2.x - an.x, 2) + Math.pow(a2.y - an.y, 2))) {
                    ...
                    a._segments.add(a5);
                    let a6 = GeometryUtil.f({ $type: Point_$type, x: c, y: d }, a2);
                    let a7 = GeometryUtil.f({ $type: Point_$type, x: c, y: d }, a3);
                    while (a7 < a6) {
                        a7 += 2 * Math.PI;
                    }
                    let a8 = ((() => {
...
let RadialGaugeNeedlePreparer = /*@__PURE__*/ (() => {
    class RadialGaugeNeedlePreparer extends Base {
        ...
        f(a, b, c, d, e) {
            ...
            let aa = f.c == 2;
            if (h) {
                let ab = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: 0, y: 0 }, l);
            ...
            if (aa) {
                let af = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: 0, y: 0 }, t);
            ...
            let aw = z;
            if (ai) {
                let ax = GeometryUtil.k({ $type: Point_$type, x: m, y: i }, { $type: Point_$type, x: p, y: k }, { $type: Point_$type, x: o, y: 0 }, q);
...
let XamRadialGauge = /*@__PURE__*/ (() => {
    class XamRadialGauge extends Control {
        ...
        b5(a) {
            ...
            let e = d.x;
            let f = d.y;
            let g = GeometryUtil.f({ $type: Point_$type, x: e, y: f }, a);
        ...
        gb(a) {
            ...
            if (aa != 0 && !ai && ab) {
                ...
                let be = GeometryUtil.k(bd, { $type: Point_$type, x: ar, y: as }, { $type: Point_$type, x: ae, y: af }, ac * k);
                let bf = au;
                let bg = av;
                if (a8 - a6 != 0) {
                    bg = ae;
                ...
                let bj = GeometryUtil.k(bi, { $type: Point_$type, x: av, y: aw }, { $type: Point_$type, x: ae, y: af }, ac * k);
                if (isNaN_(be.c.x) || isNaN_(be.c.y) || isNaN_(be.d.x) || isNaN_(be.d.y) || isNaN_(bj.c.x) || isNaN_(bj.c.y) || isNaN_(bj.d.x) || isNaN_(bj.d.y)) {
                    ...
                    if ((Math.pow(bl.x - ar, 2) + Math.pow(bl.y - as, 2)) <= (Math.pow(bk.x - ar, 2) + Math.pow(bk.y - as, 2))) {
                        ...
                        let bm = GeometryUtil.f({ $type: Point_$type, x: ae, y: af }, bk);
                        let bn = GeometryUtil.f({ $type: Point_$type, x: ae, y: af }, bl);
                        let bo = q;
                        let bp = r;
                        while (bo > Math.PI * 2) {
                            bo -= Math.PI * 2;
    ...
    class XamRadialGaugeView extends Base {
        ...
        as(a) {
            ...
            if (this.g != null) {
                ...
                this.g.ao = (m) => this.h.ba && (this.h.a8 || this.h.bc(m));
            }
            this.a6();
        }
        ag(a, b) {
...
*/
class IgcFormatRadialGaugeLabelEventArgs {
    createImplementation() {
...
*/
class IgcAlignRadialGaugeLabelEventArgs extends IgcFormatRadialGaugeLabelEventArgs {
    createImplementation() {
...
let IgcRadialGaugeRangeComponent = /*@__PURE__*/ (() => {
...
class IgcRadialGaugeRangeCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgcRadialGaugeRangeComponent.$type, XamRadialGaugeRange.$type, 0);
        coll.compare = (ext, int) => {
            let comp = ext;
            if (comp._implementation) {
                comp = comp._implementation;
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE:  you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
let IgcRadialGaugeComponent = /*@__PURE__*/ (() => {
    class IgcRadialGaugeComponent extends IgcHTMLElement {
        constructor() {
            super();
            this.contentRanges = [];
            /**
            ...
            */
            ...
            this._renderer = new WebComponentRenderer(this, document, true, RadialGaugeStylingDefaults);
            this._implementation = this.createImplementation();
            this._container = this._renderer.createElement("div");
            this._renderer.updateRoot(this._container);
            //this._renderer.rootWrapper.append(this._container);
        ...
        */
        get ranges() {
            if (this._ranges === null) {
                let coll = new IgcRadialGaugeRangeCollection();
                let inner = coll._innerColl;
                inner.addListener((sender, e) => {
                    switch (e.action) {
                        case NotifyCollectionChangedAction.Add:
        ...
        static get observedAttributes() {
            if (IgcRadialGaugeComponent._observedAttributesIgcRadialGaugeComponent == null) {
                let names = getAllPropertyNames(IgcRadialGaugeComponent);
                for (let i = 0; i < names.length; i++) {
                    names[i] = toSpinal(names[i]);
                }
    ...
    */
        ...
        */
        ...
        set formatLabel(ev) {
            ...
            this._formatLabel = ev;
            this._formatLabel_wrapped = (o, e) => {
                let outerArgs = new IgcFormatRadialGaugeLabelEventArgs();
                outerArgs._provideImplementation(e);
                if (this.beforeFormatLabel) {
                    this.beforeFormatLabel(this, outerArgs);
                }
        ...
        */
        ...
        set alignLabel(ev) {
            ...
            this._alignLabel = ev;
            this._alignLabel_wrapped = (o, e) => {
                let outerArgs = new IgcAlignRadialGaugeLabelEventArgs();
                outerArgs._provideImplementation(e);
                if (this.beforeAlignLabel) {
                    this.beforeAlignLabel(this, outerArgs);
                }
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE: you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
class IgcRadialGaugeRangeModule {
    static register() {
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE: you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
class IgcRadialGaugeCoreModule {
    static register() {
